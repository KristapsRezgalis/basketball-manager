...
let pl1 = new Player(1, "Trae Young", "PG",27,  51,74,75,87, 68,40,74,74,86,95, 25,26,88,46,10,56, 85,86,30,  7, "SG",'USA',185,74,2018,5); // UPDATED ATL
let pl2 = new Player(2, 'Asa Newell',"PF",20, 65,60,38,74,  70,50,60,60,40,19, 60,60,55,55,50,50, 80,90,90, 0, "C",'USA',208,99,2025,23); // UPDATED ATL
let pl3 = new Player(3, 'Nickeil Alexander-Walker','SG',27, 60,75,73,77, 60,50,62,74,71,39, 18,37,65,72,30,45, 80,80,30, 6,'SF','Canada',196,92,2019,17); // UPDATED ATL
let pl4 = new Player(4, 'Jacob Toppin','SF',25, 55,59,59,67, 72,52,58,58,58,37, 38,67,53,58,40,45, 75,80,50, 2,'PF','USA',206,92,0,0); // UPDATED ATL
let pl5 = new Player(5, 'Luke Kennard','SG',29, 47,79,77,89, 50,30,59,58,68,63, 18,36,64,44,10,56, 82,80,10, 8,'PG','USA',196,93,2017,12); // UPDATED ATL
let pl6 = new Player(6, "De'Andre Hunter", "SF",28, 64,70,74,84, 65,55,66,73,60,19, 14,41,76,60,15,45, 80,80,40, 6,'SG','USA',203,102,2019,4); // --> cle
let pl7 = new Player(7, "Onyeka Okongwu", "C", 25, 66,78,64,75, 65,60,64,64,44,29, 76,77,70,67,56,54, 78,83,50, 5,'PF','USA',203,106,2020,6); //  UPDATED ATL
let pl8 = new Player(8, "Garrison Mathews", "SG",29, 53,71,78,81, 55,34,40,50,66,13, 12,30,55,44,15,59, 67,79,20, 6,'SF','USA',196,97,0,0); //  --> fa
let pl9 = new Player(9, "Vit Krejci", "SG",25, 50,54,77,71, 66,30,65,65,60,56, 14,42,56,53,40,53, 70,80,50, 4,'SF','Czechia',203,88, 2020,37); //   UPDATED ATL
let pl10 = new Player(10, "Kevon Harris", "SG",28, 53,62,61,76, 64,48,61,61,59,13, 44,34,53,50,20,56, 62,80,30, 3,'SF','USA',196,97,0,0); //  --> hou
let pl11 = new Player(11, "Jalen Johnson", "SF",24, 72,68,64,75, 72,58,66,66,48,51, 34,83,79,61,50,66, 75,80,60, 4,'PF','USA',206,99,2021,20); // UPDATED ATL
let pl12 = new Player(12, "Zaccharie Risacher", "SF",20, 60,64,71,71, 57,46,60,72,69,18, 34,36,74,67,35,50, 81,80,90,  1,'SG','France',206,90,2024,1); //  UPDATED ATL
let pl13 = new Player(13, "Dyson Daniels", "PG", 22, 55,58,70,59, 65,42,69,79,76,47, 34,46,65,84,40,96, 79,80,80, 3,'SG','Australia',203,90,2022,8); // UPDATED ATL
let pl14 = new Player(14, "Keaton Wallace", "PG",26, 41,58,72,83, 62,39,70,69,62,68, 10,41,56,66,30,80, 78,84,30,  1,'SG','USA',190,88,0,0); // UPDATED ATL
let pl15 = new Player(15, "Kobe Bufkin", "SG",22, 51,69,60,72, 70,30,76,76,77,59, 30,56,60,50,30,45, 85,80,80, 2,'PG','USA',193,88,2023,15); // UPDATED ATL
let pl16 = new Player(16, 'Caleb Houstan','SG',22, 38,66,73,84, 62,30,68,72,60,26, 18,36,53,62,15,50, 76,80,80, 3,'SF','Canada',203,92,2022,32);// UPDATED ATL
let pl17 = new Player(17, "Mouhamed Gueye", "PF",23, 61,57,53,73, 65,53,57,57,50,28, 60,64,59,60,84,79, 78,80,70, 2,'C','Senegal',211,95,2023,39); // UPDATED ATL
let pl19 = new Player(19, "Kristaps Porzingis", "C",30, 80,60,77,81, 68,64,56,55,58,26, 40,64,88,67,78,45, 84,77,10, 9,'PF','Latvia',218,108,2015,4); // UPDATED ATL

// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick

let pl18 = new Player(18, "Jrue Holiday", "PG", 35, 55,61,78,83, 58,39,69,86,76,53, 26,46,70,80,40,60, 83,80,0  ,16,'SG','USA',193,92,2009,17); // --> por
let pl20 = new Player(20, "Al Horford", "C", 39, 67,73,80,76, 59,81,43,57,40,35, 34,68,55,70,60,40, 77,78,0 , 18,'PF','Dominican Republic',206,108,2007,3); // --> gsw
let pl21 = new Player(21, "Jaylen Brown", "SF", 29, 73,74,68,76, 74,59,69,78,76,41, 24,51,86,73,25,56, 80,82,10 ,9,'SG','USA',198,101,216,3); // UPDATED Boston
let pl22 = new Player(22, "Payton Pritchard", "PG",27, 45,70,75,85, 56,31,65,65,72,55, 26,45,70,46,10,50, 70,81,30, 5,'SG','USA',185,88,2020,26); // UPDATED Boston
let pl23 = new Player(23, "Jayson Tatum", "PF", 27, 79,75,75,81, 73,61,72,78,86,55, 18,77,92,74,35,55, 84,80,30  ,8,'SF','USA',203,95,2017,3); // UPDATED Boston
let pl24 = new Player(24, "Derrick White", "SG",31, 56,74,76,89, 65,36,78,83,76,57, 16,39,69,76,59,54, 77,81,0  ,8,'PG','USA',193,86,2017,29); // Boston
let pl25 = new Player(25, "Lonnie Walker IV","SG",27, 56,62,72,76, 73,54,79,79,68,26, 10,41,75,51,35,53, 70,82,40 , 7,'SF','USA',193,92,2018,18); // Boston
let pl26 = new Player(26, "Xavier Tillman Sr.", "C",26, 66,53,46,57, 59,62,36,57,51,26, 60,55,54,74,66,75, 67,80,50, 5,'PF','USA',203,111,2020,35); // Boston
let pl27 = new Player(27, "Jordan Walsh", "SF",21, 55,55,58,71, 76,44,67,67,58,37, 44,47,53,63,40,62, 60,80,100, 2,'PF','USA',201,92,2023,38); // Boston
let pl28 = new Player(28, "JD Davison", "PG", 23, 45,63,61,73, 74,44,75,75,76,72, 26,45,58,47,50,50, 55,80,80, 3,'SG','USA',185,88,2022,53); // Boston
let pl29 = new Player(29, "Luke Kornet", "C", 30, 64,46,32,82, 52,56,28,27,33,25, 86,52,55,57,84,40, 64,77,10, 8,'PF','USA',218,113,0,0); // Boston
let pl30 = new Player(30, "Sam Hauser","SF",28, 51,74,82,89, 52,56,51,52,33,17, 20,48,64,44,35,40, 67,80,30, 4,'PF','USA',203,97,0,0); // Boston
let pl31 = new Player(31, "Neemias Queta","C",26, 58,47,0,71, 55,66,49,49,28,22, 90,70,60,54,80,60, 60,80,50, 4,'C','Portugal',213,111,2021,39); // Boston
let pl32 = new Player(32, "Jaden Springer","SG",23, 45,63,40,82, 62,39,72,72,71,31, 48,33,53,65,55,90, 59,80,80, 4,'PG','USA',193,92,2021,28); // Boston
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl33 = new Player(33, "Shake Milton","SG",29 , 50,82,60,82, 67,28,67,69,74,46, 18,46,65,43,20,50, 69,83,20, 7,'PG','USA',196,92,2018,54); // Brooklyn
let pl34 = new Player(34, "Bojan Bogdanovic", "SF",36, 56,80,79,80, 55,50,57,62,64,24, 14,38,81,51,5,37, 79,84,0, 11,'PF','Bosnia and Herzegovina',201,102,2011,31); // Brooklyn
let pl35 = new Player(35, "Dorian Finney-Smith", "PF",32, 56,61,58,72, 70,52,57,72,50,20, 40,40,50,63,35,51, 77,81,0, 9,'SF','USA',201,99,0,0); // Brooklyn
let pl36 = new Player(36, "Killian Hayes", "PG",24, 50,69,37,75, 60,46,69,69,73,73, 8,39,53,58,35,66, 76,83,70, 5,'SG','France',196,88,2020,7); // Brooklyn
let pl37 = new Player(37, "Keon Johnson", "SG",23, 48,58,60,76, 88,30,83,74,62,42, 24,29,59,56,30,62, 64,80,10, 4,'SF','USA',196,84,2021,21); // Brooklyn
let pl38 = new Player(38, "Trendon Watford", "PF",25, 68,58,60,76, 70,69,53,53,40,34, 44,60,64,45,35,50, 66,80,60, 4,'C','USA',206,108,0,0); // Brooklyn
let pl39 = new Player(39, "Nic Claxton", "C",26, 67,64,25,55, 69,61,59,67,39,25, 66,87,64,73,85,45, 75,80,50, 6,'PF','USA',211,97,2019,31); // Brooklyn
let pl40 = new Player(40, "Ziaire Williams","SF",24, 57,56,50,80, 72,30,77,77,69,26, 24,50,58,57,15,54, 69,80,70,  4,'SG','USA',206,97,2021,10); // Brooklyn
let pl41 = new Player(41, "Jalen Wilson", "SF",25, 47,62,58,79, 65,20,72,69,58,24, 50,46,53,39,10,30, 65,80,60,  2,'PF','USA',203,102,2023,51); // Brooklyn
let pl42 = new Player(42, "Cameron Johnson", "PF",29, 62,71,75,82, 69,50,60,60,49,31, 24,44,77,55,20,55, 77,78,20, 6,'SF','USA',203,95,2019,11 ); // Brooklyn
let pl43 = new Player(43, "De'Anthony Melton", "SG",27, 53,50,69,77, 65,40,66,66,73,44, 24,46,66,71,40,85, 72,83,40, 7,'PG','USA',188,90,2018,46); // Brooklyn
let pl44 = new Player(44, "Ben Simmons", "SF",29, 70,36,30,44, 70,60,77,77,76,86, 40,67,55,68,45,54, 73,80,20, 7,'PG','Australia',208,108,2016,1); // Brooklyn
let pl45 = new Player(45, "Amari Bailey", "PG",21, 50,69,58,70, 61,36,74,74,69,39, 24,37,52,44,10,46, 56,90,100, 2,'SG','USA',196,83,2023,41); // Brooklyn
let pl46 = new Player(46, "Dariq Whitehead", "SF",21, 52,66,59,79, 72,42,69,69,68,34, 17,38,50,52,32,54, 60,77,100, 2,'SG','USA',201,99,2023,22); // Brooklyn
let pl47 = new Player(47, "Cam Thomas", "SG",24, 67,72,70,85, 69,44,67,67,72,33, 10,36,85,43,15,40, 72,80,70, 4,'SF','USA',193,95,2021,27); // Brooklyn
let pl48 = new Player(48, "Day'Ron Sharpe", "C",24, 54,39,36,61, 63,69,51,51,48,33, 93,89,60,57,74,45, 63,80,70, 4,'PF','USA',211,120,2021,29); // Brooklyn
let pl49 = new Player(49, "Noah Clowney", "PF",21, 65,59,56,70, 65,54,54,54,49,18, 50,67,54,56,68,40, 66,80,100, 2,'C','USA',208,95,2023,21); // Brooklyn
let pl50 = new Player(50, "Jaylen Martin", "SG",21, 51,46,40,60, 73,30,73,66,55,51, 53,44,50,50,53,36, 55,82,100, 1,'SF','USA',198,97,0,0); // Brooklyn

// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl52 = new Player(52, "LaMelo Ball", "PG",24, 63,68,70,83, 69,40,74,74,78,86, 30,56,90,63,20,75, 81,82,70, 5,'SG','USA',201,81,2020,3); // Charlotte
let pl53 = new Player(53, "Tre Mann", "PG",24, 53,70,62,77, 58,43,64,64,73,60, 14,47,59,50,15,65, 71,80,70, 4,'SG','USA',190,80,2021,18); // Charlotte
let pl54 = new Player(54, "Nick Richards","PF",28, 59,49,33,73, 65,55,62,60,25,11, 76,76,60,55,70,25, 67,84,30,  5,'C','Jamaica',213,111,2020,42); // Charlotte
let pl55 = new Player(55, "Grant Williams","PF",27, 60,63,67,76, 56,63,48,60,56,29, 30,42,60,55,38,38, 72,80,40,  5,'C','USA',198,107,2019,22 ); // Charlotte
let pl56 = new Player(56, "Seth Curry", "SG",35, 38,63,70,90, 58,31,68,68,68,31, 22,29,59,42,20,53, 73,80,0, 11,'PG','USA',185,83,0,0); // Charlotte Hornets
let pl57 = new Player(57, "Tidjane Salaun", "PF",20, 58,62,52,73, 70,50,61,72,56,32, 42,47,55,54,40,49, 68,80,100, 1,'SF','France',208,91,2024,6); // Charlotte
let pl58 = new Player(58, "Miles Bridges", "SF",27, 71,63,60,82, 72,63,65,66,66,32, 20,61,80,50,40,45, 80,85,40, 6,'PF','USA',201,102,2018,12); // Charlotte
let pl59 = new Player(59, "Taj Gibson","PF",40, 67,72,26,71, 48,73,39,47,25,20, 48,46,54,57,51,40, 65,83,0,  16,'C','USA',206,105,2009,26); // Charlotte
let pl60 = new Player(60, "Vasilije Micic", "PG",31, 47,77,47,81, 52,34,65,65,76,80, 8,23,56,42,10,45, 69,82,0,  2,'SG','Serbia',196,90,2014,52); // Charlotte
let pl61 = new Player(61, "Josh Green", "SG",25, 51,67,67,68, 70,50,76,76,60,31, 20,34,53,56,10,53, 70,83,60,  5,'PF','Australia',196,90,2020,18); // Charlotte
let pl62 = new Player(62, "Cody Martin", "SF",30, 59,32,51,65, 65,48,58,62,63,40, 32,43,50,57,35,66, 71,80,10, 6,'SG','USA',196,92,2019,36); // Charlotte
let pl63 = new Player(63, "Nick Smith Jr.","SG",21, 52,47,74,86, 76,38,74,74,69,29, 18,27,65,41,15,25, 64,80,100,   2,'PG','USA',200,100,0,0); // Charlotte
let pl64 = new Player(64, "Moussa Diabate", "C",23, 53,58,40,64, 68,50,63,63,30,23, 87,51,55,53,60,60, 57,80,80,  3,'PF','France',211,95,2022,43); // Charlotte
let pl65 = new Player(65, "Keyontae Johnson", "SG",25, 53,58,60,71, 71,50,71,68,54,32, 40,43,45,49,30,48, 60,80,60, 2,'SF','USA',200,100,0,0); // Charlotte
let pl66 = new Player(66, "Brandon Miller", "SG",23, 58,81,67,82, 75,41,68,72,76,26, 18,39,79,55,30,50, 82,80,80, 2,'SF','USA',206,91,2023,2); // Charlotte
let pl67 = new Player(67, "Mark Williams", "C",24, 67,50,0,71, 65,70,55,54,25,16, 92,86,65,59,70,53, 71,80,70, 3,'PF','USA',213,109,2022,15); // Charlotte
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl68 = new Player(68, "Torrey Craig", "SF",35, 53,44,64,71, 63,39,53,70,59,19, 46,51,51,64,50,47, 69,80,0, 8,'PF','USA',201,100,0,0); // Chicago Bulls
let pl69 = new Player(69, "Lonzo Ball", "PG",28, 52,55,66,75, 65,42,75,76,76,62, 20,47,56,70,40,72, 82,75,30, 6,'SG','USA',198,86,2017,2); // Chicago Bulls
let pl70 = new Player(70, "Jevon Carter", "PG",30, 39,79,68,79, 61,50,66,73,69,37, 14,32,55,58,30,60, 65,81,10, 7,'SG','USA',185,90,2018,32); // Chicago Bulls
let pl71 = new Player(71, "Talen Horton-Tucker", "SG",25, 62,32,49,77, 63,59,60,68,72,63, 18,40,66,56,35,69, 70,80,60, 6,'PG','USA',193,106,2019,46); // Chicago Bulls
let pl72 = new Player(72, "Josh Giddey", "SF",23, 63,75,59,80, 64,50,69,69,79,71, 42,72,73,56,40,45, 78,80,90, 4,'PG','Australia',203,95,2021,6); // Chicago Bulls
let pl73 = new Player(73, "Ayo Dosunmu", "SG",25, 52,81,69,81, 65,42,66,68,69,40, 18,30,60,53,30,53, 77,80,60, 4,'PG','USA',196,90,2021,38); // Chicago Bulls
let pl74 = new Player(74, "Jalen Smith", "PF",25, 65,62,69,74, 76,55,59,58,28,17, 74,76,64,51,65,30, 66,80,60,  5,'C','USA',208,97,2020,10); // Chicago Bulls
let pl75 = new Player(75, "Matas Buzelis", "SF",21, 63,63,63,68, 74,50,76,60,59,40, 38,57,60,54,59,48, 60,80,100, 1,'PF','Lithuania',208,94,2024,11); // Chicago Bulls
let pl76 = new Player(76, "Chris Duarte", "SG",28, 56,43,58,81, 53,49,55,58,65,25, 20,41,60,56,15,55, 69,80,30, 4,'SF','Dominican Republic',198,86,2021,13); // Chicago Bulls
let pl77 = new Player(77, "E.J. Liddell", "PF",25, 60,69,56,76, 79,55,63,63,50,28, 39,66,50,53,69,44, 52,80,60, 2,'SF','USA',201,108,2022,41); // Chicago Bulls
let pl78 = new Player(78, "Julian Phillips", "SF",22, 49,58,51,70, 70,30,63,68,56,14, 26,26,51,52,35,50, 58,80,90, 2,'PF','USA',203,89,2023,35); // Chicago Bulls
let pl79 = new Player(79, "Zach LaVine", "SG",30, 70,80,67,84, 87,39,74,74,78,44, 10,50,80,54,15,45, 82,83,10, 11,'SF','USA',196,90,2014,13); // Chicago Bulls
let pl80 = new Player(80, "Adama Sanogo", "C",23, 57,60,49,72, 52,61,60,58,40,18, 70,74,50,46,56,46, 57,80,80 , 2,'PF','Mali',206,111,0,0); // Chicago Bulls
let pl81 = new Player(81, "Dalen Terry", "SG",23, 51,62,43,61, 59,48,66,66,70,41, 34,44,50,58,45,65, 59,80,80, 3,'SF','USA',201,88,2022,18); // Chicago Bulls
let pl82 = new Player(82, "Nikola Vucevic", "C",35, 73,71,54,82, 35,79,52,39,25,35, 58,82,80,51,40,40, 81,77,0, 14,'PF','Montenegro',208,117,2011,16); // Chicago Bulls
let pl83 = new Player(83, "Coby White", "PG",25, 56,62,70,83, 71,46,75,75,76,51, 10,40,80,48,10,40, 79,80,70, 6,'SG','USA',196,88,2019,7); // Chicago Bulls
let pl84 = new Player(84, "Patrick Williams", "PF",24, 51,69,75,77, 67,54,60,65,60,17, 26,54,55,62,50,53, 77,81,70, 5,'SF','USA',201,97,2020,4); // Chicago Bulls
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl85 = new Player(85, "Donovan Mitchell", "SG",29, 65,84,70,86, 87,50,85,80,80,62, 18,43,91,68,30,70, 84,80,20, 8,'PG','USA',190,97,2017,13); //Cleveland
let pl86 = new Player(86, "Ty Jerome", "SG",28, 48,77,60,83, 52,46,59,63,76,55, 12,33,60,47,10,55, 67,80,30, 6,'PG','USA',196,88,2019,24); //Cleveland
let pl87 = new Player(87, "Evan Mobley", "PF",24, 73,59,47,71, 71,64,62,69,50,38, 52,84,77,77,71,53, 83,80,70, 4,'C','USA',211,97,2021,3); //Cleveland
let pl88 = new Player(88, "Jarrett Allen", "C",27, 75,72,27,74, 69,74,65,62,25,31, 74,80,66,68,73,40, 78,82,40, 8,'PF','USA',211,110,2017,22); //Cleveland
let pl89 = new Player(89, "Caris LeVert", "SG",31, 64,61,54,74, 70,44,65,67,76,53, 18,40,70,56,25,60, 78,78,0, 9,'SF','USA',198,92,2016,20); //Cleveland
let pl90 = new Player(90, "Sam Merrill", "SG",29, 45,71,80,89, 50,34,52,54,66,34, 14,33,65,42,5,40, 64,79,20, 5,'PG','USA',193,92,2020,60); //Cleveland
let pl91 = new Player(91, "Dean Wade", "PF",29, 59,60,70,69, 73,50,52,58,50,18, 22,53,50,56,30,55, 69,79,20, 6,'SF','USA',206,103,0,0); //Cleveland
let pl92 = new Player(92, "Darius Garland", "PG",25, 49,76,74,86, 74,30,78,78,79,71, 10,23,80,48,5,56, 83,80,60, 6,'SG','USA',185,87,2019,5); //Cleveland
let pl93 = new Player(93, "Isaac Okoro", "SF",24, 57,50,66,70, 70,57,67,75,62,22, 24,25,53,66,25,53, 77,82,70, 5,'SG','USA',196,102,2020,5); //Cleveland
let pl94 = new Player(94, "Max Strus", "SF",29, 55,75,70,81, 64,30,66,66,59,31, 16,38,64,42,15,40, 75,85,20, 6,'SG','USA',196,97,0,0); //Cleveland
let pl95 = new Player(95, "Georges Niang", "PF",32, 55,74,79,86, 62,50,34,45,57,20, 12,44,65,46,15,35, 66,84,0, 9,'SF','USA',201,104,2016,50); //Cleveland
let pl96 = new Player(96, "Craig Porter Jr.","PG",25, 51,76,43,73, 62,38,69,69,63,66, 22,49,60,52,45,53, 62,80,60, 2,'SG','USA',188,84,0,0); //Cleveland
let pl97 = new Player(97, "Jaylon Tyson", "SG",23, 54,68,56,79, 65,53,70,66,65,37, 21,47,51,47,40,46, 60,80,80, 1,'SF','USA',198,97,2024,20); //Cleveland
let pl98 = new Player(98, "JT Thor", "PF",23, 59,62,52,64, 72,40,74,74,50,15, 32,45,49,53,55,35, 62,80,80, 4,'C','USA',208,92,2021,37); //Cleveland
let pl99 = new Player(99, "Luke Travers", "SG",24, 46,62,54,68, 65,38,58,56,61,21, 27,33,50,45,46,36, 60,80,70, 1,'SF','Australia',203,90,2022,56); //Cleveland
let pl100 = new Player(100, "Tristan Thompson", "C",34, 57,57,25,59, 64,64,53,54,29,14, 88,68,52,53,45,35, 61,90,0, 14,'PF','Canada',206,115,2011,4); //Cleveland
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl101 = new Player(101, "Luka Doncic", "PG",26, 80,78,78,78, 69,62,74,74,85,90, 16,81,98,62,25,59, 87,85,50, 7,'SG','Slovenia',201,104,2018,3); // LA Lakers
let pl102 = new Player(102, "Kyrie Irving", "SG",33, 58,88,81,90, 70,27,75,75,89,53, 40,44,90,56,25,60, 84,80,0, 14,'PG','USA',188,88,2011,1); // Dallas
let pl103 = new Player(103, "Spencer Dinwiddie", "PG",32, 58,42,60,79, 65,35,72,72,78,60, 10,29,59,52,20,45, 77,77,0,  11,'SG','USA',196,97,2014,38); // Dallas
let pl104 = new Player(104, "Quentin Grimes", "SG",25, 52,58,67,76, 65,53,76,76,64,23, 16,31,60,59,20,50, 72,80,60, 4,'SF','USA',196,92,2021,25); // Dallas
let pl105 = new Player(105, "Klay Thompson", "SF",35, 52,80,81,85, 57,52,61,70,57,26, 12,35,77,64,30,45, 82,94,0, 12,'SG','USA',198,97,2011,11); // Dallas
let pl106 = new Player(106, "Dereck Lively II", "C",21, 66,50,0,51, 57,60,40,47,42,19, 78,68,59,60,83,50, 73,80,100, 2,'PF','USA',2016,104,2023,12);  // Dallas
let pl107 = new Player(107, "Dante Exum", "PG",30, 49,63,76,76, 67,38,69,72,65,52, 16,41,60,52,15,40, 68,83,10, 8,'SG','Australia',196,97,2014,5); // Dallas
let pl108 = new Player(108, "Maxi Kleber", "PF",33, 63,60,58,77, 46,69,45,67,54,28, 36,54,50,66,60,35, 72,80,0, 8,'C','Germany',208,108,0,0); // Dallas
let pl109 = new Player(109, "P.J. Washington", "PF",27, 70,69,58,70, 59,58,65,65,60,26, 28,52,65,51,54,53, 80,79,40, 6,'SF','USA',201,104,2019,12); // Dallas
let pl110 = new Player(110, "Daniel Gafford", "C",27, 69,55,0,67, 70,63,65,60,25,18, 76,62,66,66,90,51, 69,80,40, 6,'PF','USA',208,106,2019,38); // Dallas
let pl111 = new Player(111, "Naji Marshall", "SF",27, 61,70,55,78, 65,50,52,55,64,38, 30,54,60,49,20,60, 69,80,40, 5,'PF','USA',201,99,0,0); // Dallas
let pl112 = new Player(112, "Olivier-Maxence Prosper", "PF",23, 54,58,40,66, 78,50,69,71,50,25, 62,57,59,55,20,55, 60,80,80, 2,'SF','Canada',203,104,2023,24); // Dallas
let pl113 = new Player(113, "Jaden Hardy", "SG",23, 57,53,69,78, 75,39,73,73,73,40, 14,40,69,43,15,45, 64,80,80, 3,'PG','USA',193,89,2022,37); // Dallas
let pl114 = new Player(114, "Dwight Powell", "C",34, 72,55,39,73, 57,70,61,48,50,36, 66,55,53,63,45,56, 68,83,0, 11,'PF','Canada',208,108,2014,45); // Dallas
let pl115 = new Player(115, "Brandon Williams", "PG",26, 50,67,47,69, 58,52,69,69,69,51, 22,31,60,46,25,55, 66,81,50, 3,'SG','USA',185,86,0,0); // Dallas
let pl116 = new Player(116, "Kessler Edwards", "SF",25, 54,62,62,74, 60,67,62,64,54,20, 32,43,56,59,40,55, 61,80,60, 4,'PF','USA',203,97,2021,44); // Dallas
let pl117 = new Player(117, "Cooper Flagg", "SF",19, 64,60,60,84, 80,60,65,65,60,52, 30,65,70,75,65,65, 80,80,100, 0,'PF','USA',206,92,2025,1); // updated DAL
// ins/2p/3p/ft/jum/str/spe/qui/dri/pas/ore/dre/oaw/daw/blk/stl/end/inj/pot - experience
let pl118 = new Player(118, "Nikola Jokic", "C",30, 85,84,65,81, 53,86,53,52,66,93, 58,96,97,68,45,58, 81,83,10,  10,'PF','Serbia',211,128,2014,41); // Denver
let pl119 = new Player(119, "Aaron Gordon", "PF",30, 75,60,62,68, 82,62,61,76,52,41, 54,56,73,64,40,45, 79,84,10, 11,'SF','USA',203,106,2014,4); // Denver
let pl120 = new Player(120, "Michael Porter Jr.", "SF",27, 63,80,75,78, 78,58,70,71,68,17, 32,63,80,49,35,40, 78,66,40, 6,'PF','USA',208,98,2018,14); // Denver
let pl121 = new Player(121, "Julian Strawther", "SG",23, 51,57,65,80, 54,43,53,60,64,30, 8,37,69,55,25,55, 65,80,80, 2,'SF','USA',201,92,2023,29); // Denver
let pl122 = new Player(122, "Russell Westbrook","PG",37, 58,60,47,68, 80,65,79,79,76,72, 44,59,70,57,25,67, 83,92,0, 17,'SG','USA',193,90,2008,4); // Denver
let pl123 = new Player(123, "Dario Saric", "PF",31, 67,61,69,83, 50,55,53,59,59,40, 44,63,69,58,15,50, 72,81,0, 8,'C','Croatia',208,102,2014,12); // Denver
let pl124 = new Player(124, "Christian Braun", "SG",24, 51,67,67,71, 73,46,73,73,59,29, 34,49,65,61,40,56, 70,80,70, 3,'SF','USA',198,98,2022,21); // Denver
let pl125 = new Player(125, "DaRon Holmes", "PF",23, 64,66,55,70, 54,50,65,59,50,21, 60,68,50,61,70,50, 60,80,80, 1,'C','USA',208,102,2024,22); // Denver
let pl126 = new Player(126, "Jamal Murray", "PG",28, 60,83,80,85, 70,44,70,70,79,74, 18,39,84,55,40,53, 81,78,30,  8,'SG','Canada',193,97,2016,7); // Denver
let pl127 = new Player(127, "DeAndre Jordan", "C",37, 51,25,0,47, 73,75,55,52,20,13, 74,92,54,55,65,35, 75,94,0, 17,'C','USA',211,120,2008,35); // Denver
let pl128 = new Player(128, "Zeke Nnaji", "PF",24, 67,66,49,65, 72,60,67,67,27,20, 76,41,56,51,84,45, 61,83,70, 5,'C','USA',206,108,2020,22); // Denver
let pl129 = new Player(129, "Hunter Tyson", "PF",25, 54,66,54,80, 67,42,58,58,58,18, 30,53,53,47,35,35, 60,80,60, 2,'SF','USA',203,97,2023,37); // Denver
let pl130 = new Player(130, "Jalen Pickett", "SG",26, 53,58,70,76, 57,49,62,62,65,69, 8,41,63,49,20,40, 60,79,50, 2,'PG','USA',193,94,2023,32); // Denver
let pl131 = new Player(131, "Peyton Watson", "SF",23, 53,70,55,69, 72,45,67,70,60,22, 28,49,60,69,80,55, 68,80,80, 3,'SG','USA',203,90,2022,30); // Denver
let pl132 = new Player(132, "Vlatko Cancar", "PF",28, 50,60,62,84, 60,53,50,64,54,32, 26,44,56,54,30,45, 60,80,30, 5,'SF','Slovenia',203,107,2017,49); // Denver
let pl133 = new Player(133, "PJ Hall", "C",23, 60,62,51,78, 72,60,63,42,50,17, 42,50,50,47,50,40, 60,80,80, 1,'PF','USA',203,111,0,0); // Denver
let pl134 = new Player(134, "Trey Alexander", "SG",22, 40,68,54,82, 57,34,68,65,63,44, 24,36,50,41,30,41, 60,80,90, 1,'PG','USA',193,83,0,0); // Denver
// ins/2p/3p/ft/jum/str/spe/qui/dri/pas/ore/dre/oaw/daw/blk/stl/end/inj/pot
let pl135 = new Player(135, "Malik Beasley", "SG",29, 57,87,74,78, 69,45,65,65,69,21, 12,37,77,44,10,50, 73,84,20, 9,'SF','USA',193,84,2016,19); //Detroit
let pl136 = new Player(136, "Cade Cunningham", "PG",24, 67,84,53,85, 70,52,73,73,76,81, 16,48,84,59,30,55, 83,80,70, 4,'SG','USA',198,98,2021,1); //Detroit
let pl137 = new Player(137, "Ausar Thompson", "SF",22, 54,53,39,60, 88,40,84,80,73,41, 60,60,65,74,56,85, 73,80,90, 2,'PF','USA',200,100,0,0); //Detroit
let pl138 = new Player(138, "Jaden Ivey", "SG",23, 58,73,66,74, 75,44,81,81,76,54, 26,31,77,56,35,45, 80,80,80, 3,'PG','USA',193,88,2022,5);//Detroit
let pl139 = new Player(139, "Isaiah Stewart", "PF",24, 69,66,64,73, 60,76,53,61,24,18, 68,71,56,51,60,30, 75,77,70, 5,'C','USA',203,113,2020,16);//Detroit
let pl140 = new Player(140, "Jalen Duren", "C",22, 72,45,0,69, 74,71,63,63,49,30, 88,93,65,56,56,40, 76,80,90, 3,'PF','USA',208,113,2022,13);//Detroit
let pl141 = new Player(141, "Cory Joseph", "PG",32, 60,69,58,78,48,40,70,70,72,59,16,34,53,50,20,55,70,90,0, 3,'PF','USA',200,100,0,0);
let pl142 = new Player(142, "Tim Hardaway Jr.", "SG",33, 53,72,66,81, 68,45,58,65,68,24, 8,39,74,44,10,40, 77,83,0, 12,'SF','USA',196,92,2013,24);//Detroit
let pl143 = new Player(143, "Hamidou Diallo", "SG",25, 62,59,45,62,85,48,78,78,64,31,38,55,65,51,25,66,65,86,70, 3,'PF','USA',200,100,0,0);
let pl144 = new Player(144, "Kevin Knox", "SF",24, 50,49,56,70,60,59,72,72,60,25,20,46,59,47,25,35,65,88,75, 3,'PF','USA',200,100,0,0);
let pl145 = new Player(145, "Isaiah Livers", "PF",25, 48,56,62,82,55,48,69,69,58,38,35,46,53,47,30,54,68,85,70, 3,'PF','USA',200,100,0,0);
let pl146 = new Player(146, "Rodney McGruder", "SG",32, 63,57,60,65,55,45,68,65,60,33,30,37,49,55,15,45,67,84,0, 3,'PF','USA',200,100,0,0);
let pl147 = new Player(147, "Buddy Boeheim", "PG",24, 54,63,64,80,53,44,55,55,54,51,25,37,50,40,46,32,60,90,70, 3,'PF','USA',200,100,0,0);
let pl148 = new Player(148, "Tobias Harris", "PF",33, 71,75,63,87, 69,63,65,57,69,33, 22,59,65,53,30,53, 81,82,0, 14,'SF','USA',203,102,2011,19);//Detroit
let pl149 = new Player(149, "Alec Burks", "SG",32, 54,61,66,79, 53,45,73,73,65,42, 18,46,66,52,72,88, 79,85,0, 3,'PF','USA',200,100,0,0);
let pl150 = new Player(150, "Marvin Bagley III", "PF",24, 68,66,49,66,65,68,70,71,52,23,70,71,77,47,50,35,75,83,80, 3,'PF','USA',200,100,0,0);
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot
let pl151 = new Player(151, "Stephen Curry", "PG",37, 53,80,90,92, 63,38,74,74,87,60, 12,44,97,55,20,40, 84,86,0,  16,'SG','USA',188,83,2009,7); // Golden State
let pl152 = new Player(152, "Andrew Wiggins", "SF",30, 65,66,69,77, 87,47,72,72,69,24, 40,40,77,58,40,50, 83,83,10, 11,'PF','USA',201,89,2014,1); // Golden State
let pl153 = new Player(153, "Trayce Jackson-Davis", "PF",25, 65,60,10,58, 78,53,69,69,56,31, 82,68,67,51,83,45, 67,80,60, 2,'C','USA',206,111,2023,57); // Golden State
let pl154 = new Player(154, "Brandin Podziemski", "SG",22, 56,59,60,73, 68,44,72,72,70,50, 44,57,58,49,15,56, 75,80,90, 2,'PG','USA',196,92,2023,19); // Golden State
let pl155 = new Player(155, "Kyle Anderson", "PF",32, 49,60,56,71, 56,52,56,70,71,67, 26,59,55,69,50,60, 71,83,0, 11,'SF','USA',206,104,2014,30); // Golden State
let pl156 = new Player(156, "Draymond Green", "PF",35, 57,51,52,71, 56,75,63,72,68,71, 28,74,51,76,53,59, 78,88,0, 13,'SF','USA',198,104,2012,35); // Golden State
let pl157 = new Player(157, "Kevon Looney", "C",29, 59,58,46,60, 53,64,48,59,51,40, 86,83,55,59,50,53, 67,84,20, 10,'PF','USA',206,100,2015,30); // Golden State
let pl158 = new Player(158, "Gary Payton II", "SG",33, 54,55,56,60, 75,40,71,73,68,30, 48,46,58,78,50,85, 64,83,0, 9,'PG','USA',188,86,0,0); // Golden State
let pl159 = new Player(159, "Buddy Hield", "SG",33, 50,60,78,86, 68,40,65,68,69,39, 20,43,77,50,35,56, 78,82,0, 9,'SF','Bahamas',193,99,2016,6); // Golden State
let pl160 = new Player(160, "Moses Moody", "SG",23, 56,64,69,75, 60,58,63,67,64,18, 40,41,66,56,35,60, 64,80,80, 4,'SF','USA',196,92,2021,14); // Golden State
let pl161 = new Player(161, "Jonathan Kuminga", "PF",23, 65,70,54,70, 80,63,74,74,57,28, 34,48,75,57,35,50, 71,80,80, 4,'SF','Democratic Republic of the Congo ',203,95,2021,7); // Golden State
let pl162 = new Player(162, "Lindy Waters III", "SG",28, 46,73,70,80, 57,33,50,59,59,31, 18,44,64,51,40,50, 63,80,30, 4,'SF','USA',198,97,0,0); // Golden State
let pl163 = new Player(163, "Gui Santos", "PF",23, 53,59,71,82, 64,40,63,62,52,35, 46,53,60,55,25,55, 60,86,80, 2,'SF','Brazil',203,94,2022,55); // Golden State
let pl164 = new Player(164, "Quinten Post", "C",25, 56,64,62,81, 40,56,47,43,33,20, 60,63,50,45,60,40, 60,80,60, 1,'PF','Netherlands',213,107,2024,52); // Golden State
let pl165 = new Player(165, "Pat Spencer", "PG",29, 53,68,69,80, 73,44,65,65,63,64, 25,40,55,40,45,42, 60,84,20,  2,'SG','USA',200,100,0,0); // Golden State
let pl166 = new Player(166, "Dennis Schroder", "PG",32, 44,76,67,83, 64,36,74,78,76,71, 12,29,66,50,10,45, 77,80,0, 12,'SG','Germany',185,78,2013,17); // Golden State
// ins/2p/3p/ft/jum/str/spe/qui/dri/pas/ore/dre/oaw/daw/blk/stl/end/inj/pot
...
let pl167 = new Player(167, "Jalen Green","SG",23, 66,73,63,80, 82,45,78,78,76,40, 12,53,82,52,20,45, 82,80,80, 4,'PG','USA',193,80,2021,2); // Houston
let pl168 = new Player(168, "Fred VanVleet","PG",31, 44,66,67,86, 65,42,73,73,76,80, 10,35,70,62,25,53, 81,82,0, 9,'SG','USA',183,89,0,0); // Houston
let pl169 = new Player(169, "Jabari Smith","PF",22, 70,70,60,80, 65,50,66,66,65,16, 42,71,65,56,50,40, 81,80,90, 3,'C','USA',211,99,2022,3); // Houston
let pl170 = new Player(170, "Tari Eason","PF",24, 57,79,56,73, 70,60,70,70,60,24, 76,65,69,73,60,86, 71,80,70, 3,'SF','USA',203,97,2022,17); // Houston
let pl171 = new Player(171, "Amen Thompson","SF",22, 60,61,30,69, 89,40,85,80,76,42, 76,68,66,66,55,80, 73,80,90, 2,'SG','USA',201,94,2023,4); // Houston
let pl172 = new Player(172, "Dillon Brooks","SF",29, 61,69,64,80, 65,55,65,81,64,25, 18,31,68,68,15,53, 79,85,20, 8,'PF','Canada',198,102,2017,45); // Houston
let pl173 = new Player(173, "Cam Whitmore","SG",21, 58,73,63,67, 74,58,74,74,76,14, 36,54,81,51,35,56, 67,80,100, 2,'PF','USA',201,105,2023,20); // Houston
let pl174 = new Player(174, "Jock Landale","C",30, 65,65,38,76, 65,54,44,44,42,31, 82,50,60,51,62,45, 62,80,10, 4,'PF','Australia',211,116,0,0); // Houston
let pl175 = new Player(175, "Alperen Sengun","C",23, 75,70,38,69, 59,76,42,54,52,55, 62,71,83,60,54,59, 77,80,80,  4,'PF','Turkey',211,106,2021,16); // Houston
let pl176 = new Player(176, "Steven Adams","C",32, 65,55,10,53, 58,79,48,53,25,21, 88,71,53,59,59,55, 76,82,0, 11,'PF','USA',211,120,2013,12); // Houston
let pl177 = new Player(177, "Aaron Holiday","PG",29, 43,64,74,85, 46,40,66,67,76,45, 30,29,64,49,20,59, 66,84,20, 7,'SG','USA',183,83,2018,23); // Houston
let pl178 = new Player(178, "Reed Sheppard","SG",21, 48,69,74,83, 77,46,80,79,66,55, 15,32,62,61,27,68, 73,80,100, 1,'PG','USA',188,83,2024,3); // Houston
// ins/2p/3p/ft/jum/str/spe/qui/dri/pas/ore/dre/oaw/daw/blk/stl/end/inj/pot
let pl179 = new Player(179, "Tyrese Haliburton","PG",25, 59,87,72,85, 60,49,73,73,82,96, 12,38,85,63,40,65, 82,80,60, 5,'SG','USA',196,83,2020,12); // Indiana
let pl180 = new Player(180, "Bennedict Mathurin","SG",23, 61,74,63,82, 72,44,74,74,69,25, 28,41,78,47,10,40, 77,80,80, 3,'SF','USA',198,85,2022,6); // Indiana
let pl181 = new Player(181, "Pascal Siakam","PF",31, 78,75,56,76, 69,60,66,68,69,46, 38,59,85,66,35,50, 81,82,0, 9,'SF','Cameroon',203,104,2016,27); // Indiana
let pl182 = new Player(182, "T.J. McConnell","PG",33, 43,82,64,77, 55,40,66,72,69,85, 20,43,70,67,10,80, 71,83,0, 10,'SG','USA',185,86,0,0); // Indiana
let pl183 = new Player(183, "Jarace Walker","PF",22, 62,70,70,67, 80,70,71,71,52,42, 26,57,63,63,56,80, 64,80,90, 2,'SF','USA',203,108,2023,8); // Indiana
let pl184 = new Player(184, "Isaiah Jackson","PF",23, 63,59,20,67, 71,55,63,63,49,17, 82,62,67,59,89,62, 65,80,80, 4,'C','USA',208,93,2021,22); // Indiana
let pl185 = new Player(185, "Andrew Nembhard","SG",25, 51,56,60,80, 61,40,66,71,69,60, 16,27,63,60,10,60, 76,80,60, 3,'PG','Canada',196,87,2022,31); // Indiana
let pl186 = new Player(186, "James Wiseman","C",24, 66,57,26,68, 58,60,60,60,56,14, 72,75,67,55,60,20, 68,87,70, 4,'PF','USA',213,108,2020,2); // Indiana
let pl187 = new Player(187, "Ben Sheppard","SG",24, 51,68,67,90, 65,44,74,74,63,23, 18,34,55,60,25,58, 66,80,70, 2,'SF','USA',198,86,2023,26); // Indiana
let pl188 = new Player(188, "Aaron Nesmith","SF",26, 57,76,75,80, 69,42,68,66,60,18, 24,43,69,59,45,56, 70,81,50, 5,'SG','USA',196,97,2020,14); // Indiana
let pl189 = new Player(189, "Quenton Jackson","PG",27, 48,58,55,75, 78,40,75,75,61,43, 22,24,64,58,25,60, 63,79,40, 3,'SG','USA',196,79,0,0); // Indiana
let pl190 = new Player(190, "Thomas Bryant","C",28, 67,59,60,77, 42,70,52,47,43,20, 66,82,65,52,65,40, 68,82,30, 8,'PF','USA',208,112,2017,42); // Indiana
let pl191 = new Player(191, "Myles Turner","C",29, 72,83,59,77, 59,70,46,56,25,17, 40,73,75,70,85,45, 78,83,20, 10,'PF','USA',211,113,2015,11); // Indiana
let pl192 = new Player(192, "James Johnson","PF",38, 63,50,48,67, 62,70,57,64,64,39, 28,49,56,67,50,45, 69,83,0, 16,'SF','USA',201,108,2009,16); // Indiana
let pl193 = new Player(193, "Obi Toppin","PF",27, 72,66,65,77, 80,64,60,59,50,27, 36,53,73,47,45,50, 66,88,40, 5,'SF','USA',206,99,2020,8); // Indiana
let pl194 = new Player(194, "Johnny Furphy","SG",21, 55,67,64,77, 67,44,69,53,49,15, 42,36,50,50,57,56, 60,80,100, 1,'SF','Australia',203,90,2024,35); // Indiana
let pl195 = new Player(195, "Enrique Freeman","PF",25, 60,56,46,67, 71,50,64,64,52,19, 26,45,50,53,45,35, 60,80,60, 1,'SF','USA',201,93,2024,50); // Indiana
// FINISHED UPDATING AGES + EXPERIENCE HERE
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl196 = new Player(196, "Norman Powell","SG",32, 52,75,80,82, 70,36,69,73,69,23, 10,35,82,58,20,50, 73,82,0, 10,'SF','USA',190,97,2015,46); // Clippers
let pl197 = new Player(197, "Bones Hyland", "SG",25, 54,55,60,78, 58,32,77,77,69,62, 10,42,75,46,25,64, 68,80,70, 4,'SG','USA',188,78,2021,26); // Clippers
let pl198 = new Player(198, "Ivica Zubac","C",28, 72,64,10,72, 65,70,26,35,25,19, 78,86,67,50,72,25, 71,80,30, 9,'PF','Bosnia and Herzegovina',213,108,2016,32); // Clippers
let pl199 = new Player(199, "Amir Coffey","SG",28, 51,72,66,81, 65,42,65,65,65,24, 14,32,58,50,15,45, 67,79,30, 6,'SF','USA',201,95,0,0); // Clippers
let pl200 = new Player(200, "Terance Mann","SG",29, 57,53,63,79, 69,40,61,63,69,31, 34,43,59,48,20,40, 72,80,20, 6,'SF','USA',196,97,2019,48); // Clippers
let pl201 = new Player(201, "Nicolas Batum","PF",37, 54,69,74,71, 70,55,58,65,61,40, 32,42,50,56,45,55, 75,83,0, 17,'SF','France',203,104,2008,25); // Clippers
let pl202 = new Player(202, "Kris Dunn","SG",31, 49,69,63,72, 73,46,73,73,76,65, 16,44,55,68,35,84, 73,84,0, 9,'SF','USA',190,92,2016,5); // Clippers
let pl203 = new Player(203, "Kevin Porter Jr.","SG",25, 59,75,65,72, 65,42,75,65,72,60, 20,42,78,49,20,60, 79,80,60, 5,'PG','USA',193,92,2019,30); // Clippers
let pl204 = new Player(204, "Derrick Jones Jr.","SF",28, 66,58,52,70, 83,49,67,69,58,15, 44,38,59,63,56,56, 69,78,30, 9,'PF','USA',196,95,0,0); // Clippers
let pl205 = new Player(205, "Mo Bamba","C",27, 62,55,64,68, 65,58,65,54,36,20, 74,83,59,61,89,40, 67,81,40, 7,'PF','USA',213,104,2018,6); // Clippers
let pl206 = new Player(206, "Kai Jones","C",24, 48,59,21,67, 59,55,56,56,25,13, 48,55,53,65,80,55, 60,80,70, 3,'PF','USA',211,98,2021,19); // Clippers
let pl207 = new Player(207, "James Harden","PG",36, 70,71,74,87, 70,61,75,75,85,90, 12,50,80,58,40,55, 84,95,0,  16,'SG','USA',196,99,2009,3); // Clippers
let pl208 = new Player(208, "Jordan Miller","SF",25, 52,60,52,86, 71,42,74,68,59,12, 54,25,60,50,40,50, 60,80,60, 2,'SG','USA',201,88,2023,48); // Clippers
let pl209 = new Player(209, "Kawhi Leonard","SF",34, 75,80,79,87, 69,69,74,80,76,36, 26,52,90,78,45,70, 81,80,0,  13,'PF','USA',201,102,2011,15); // Clippers
let pl210 = new Player(210, "Cam Christie","SG",20, 49,69,60,79, 67,42,77,72,60,31, 22,38,55,43,30,39, 60,80,100, 1,'PG','USA',196,86,2024,46); // Clippers
let pl211 = new Player(211, "Trentyn Flowers","SF",20, 56,61,55,64, 82,42,73,65,59,24, 28,44,50,46,37,57, 60,80,100, 1,'PF','USA',201,83,0,0); // Clippers
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl212 = new Player(212, "LeBron James", "SF", 41, 80,68,75,73,79,79,82,82,82,85,18,56,98,70,30,59,90,87,0, 22, "PF",'USA',206,113,2003,1); //Lakers
let pl213 = new Player(213, "Anthony Davis","C", 32, 80,69,29,82,76,82,74,73,65,35,64,90,95,84,87,58,85,80,0, 13, "PF",'USA',208,114,2012,1); //Dallas
let pl214 = new Player(214, "D'Angelo Russell","PG", 29, 60,71,83,80,61,44,76,76,80,70,8,30,79,50,25,50,80,83,30, 10, "SG",'USA',190,87,2015,2); //Lakers
let pl215 = new Player(215, "Christian Wood", "PF",30, 75,61,50,70,56,64,52,46,50,20,36,87,70,54,59,40,73,81,10, 9, "C",'USA',203,97,0,0); //Lakers
let pl216 = new Player(216, "Jarred Vanderbilt", "PF", 26, 55,59,29,66,70,60,65,73,55,22,60,73,50,78,40,82,70,78,50, 7, "C",'USA',203,97,2018,41); //Lakers
let pl217 = new Player(217, "Gabe Vincent", "PG", 29, 45,83,69,84, 56,30,68,68,70,35, 30,23,54,49,5,59, 70,82,20, 6, "SG",'USA',190,88,0,0); //Lakers
let pl218 = new Player(218, "Jaxson Hayes", "C", 25, 68,58,26,62, 65,62,50,58,30,24, 56,58,56,62,54,58, 66,80,60, 6, "PF",'USA',213,99,2019,8); //Lakers
let pl219 = new Player(219, "Rui Hachimura", "PF", 27, 70,75,72,74, 70,69,62,64,62,26, 22,47,74,50,25,40, 76,80,50, 6, "SF",'Japan',203,104,2019,9); //Lakers
let pl220 = new Player(220, "Cam Reddish", "SF", 26, 58,50,66,83, 74,42,75,75,71,28, 20,33,57,65,25,67, 73,80,50, 6, "SG",'USA',203,98,2019,10); //Lakers
let pl221 = new Player(221, "Jordan Goodwin", "PG", 26, 46,61,50,75, 45,40,65,66,68,56, 48,64,54,60,35,64, 67,80,60, 4, "SG",'USA',190,90,0,0); //Lakers
let pl222 = new Player(222, "Austin Reaves", "SG", 27, 57,73,69,85, 70,40,73,73,63,62, 16,40,73,53,15,45, 78,80,60, 4, "PG",'USA',196,93,0,0); //Lakers
let pl223 = new Player(223, "Max Christie", "SG", 22, 55,70,67,78, 72,45,77,77,60,23, 12,48,52,52,30,40, 64,80,90, 3, "SF",'USA',198,86,2022,35); //Lakers
let pl224 = new Player(224, "Bronny James", "SG", 20, 51,53,59,68, 80,50,77,77,60,40, 22,40,55,60,40,55, 70,90,100, 1, "PG",'USA',188,95,2024,55); //Lakers
let pl225 = new Player(225, "Jalen Hood-Schifino", "SG", 22, 55,69,53,70, 62,38,69,69,72,46, 14,36,55,50,35,50, 55,80,80, 2, "PG",'USA',198,97,2023,17); //Lakers
let pl226 = new Player(226, "Maxwell Lewis", "SF", 23, 46,60,57,67, 65,34,57,65,60,21, 20,30,46,46,31,33, 53,80,70, 2, "SG",'USA',201,88,2023,40); //Lakers
let pl227 = new Player(227, "Dalton Knecht", "SF", 24, 58,69,70,77, 67,40,76,49,58,30, 20,40,75,45,30,35, 60,80,80, 1, "SG",'USA',196,98,2024,17); //Lakers
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl228 = new Player(228, 'Ja Morant','PG',26, 67,80,51,76, 87,42,85,85,86,83, 22,50,90,62,30,53, 82,80,60, 6,'SG','USA',188,78,2019,2); //Memphis
let pl229 = new Player(229, 'Jaren Jackson Jr.','C',26, 75,58,58,80, 65,72,53,70,50,26, 34,53,84,76,80,55, 78,94,50, 7,'PF','USA',208,109,2018,4); //Memphis
let pl230 = new Player(230, 'Desmond Bane','SG',27, 60,75,81,87, 68,46,64,70,72,57, 18,44,85,62,25,53, 79,78,40, 5,'SF','USA',196,97,2020,30); //Memphis
let pl231 = new Player(231, 'GG Jackson II','SF',21, 65,60,65,75, 72,52,72,69,52,17, 30,42,70,50,35,40, 75,80,100, 2,'PF','USA',206,97,2023,45); //Memphis
let pl232 = new Player(232, 'Brandon Clarke','PF',29, 66,76,28,69, 70,54,74,73,59,24, 70,64,68,68,66,59, 71,80,20, 6,'C','Canada',203,97,2019,21); //Memphis
let pl233 = new Player(233, "Marcus Smart", "PG",31, 45,80,51,76, 70,63,65,83,64,56, 16,30,59,77,20,80, 80,83,0, 11,'SG','USA',190,99,2014,6); //Memphis
let pl234 = new Player(234, 'Luke Kennard','SG',29, 47,70,90,88, 50,30,59,58,68,59, 16,40,65,38,5,40, 73,80,20, 8,'PG','USA',196,93,2017,12); //Memphis
let pl235 = new Player(235, 'Santi Aldama','PF',24, 64,66,64,69, 49,60,49,50,32,31, 38,62,60,56,56,50, 71,79,70, 4,'SF','Spain',211,101,2021,30); //Memphis
let pl236 = new Player(236, 'Zach Edey','C',23, 70,50,30,70, 56,65,36,21,29,20, 69,75,60,52,72,33, 68,80,80, 1,'PF','Canada',224,137,2024,9); //Memphis
let pl237 = new Player(237, 'Jaylen Wells','SF',22, 48,62,69,81, 57,50,76,65,65,24, 24,40,52,39,30,33, 65,80,90, 1,'SG','USA',203,92,2024,39); //Memphis
let pl238 = new Player(238, 'Vince Williams Jr.','SG',25, 51,50,65,80, 60,42,58,72,60,44, 30,58,59,64,45,56, 73,80,60, 3,'SF','USA',193,92,2022,47); //Memphis
let pl239 = new Player(239, 'Jake LaRavia','PF',24, 61,66,54,82, 62,52,49,59,58,26, 46,34,60,50,25,59, 67,80,70, 3,'SF','USA',203,106,2022,19); //Memphis
let pl240 = new Player(240, 'Scotty Pippen Jr.','PG',25, 45,68,70,74, 69,29,72,72,69,67, 30,31,64,52,35,85, 70,80,60, 3,'SG','USA',185,83,0,0); //Memphis
let pl241 = new Player(241, 'John Konchar','SF',29, 49,66,66,80, 60,30,52,59,66,34, 44,57,45,54,60,66, 68,84,20, 6,'SG','USA',196,95,0,0); //Memphis
let pl242 = new Player(242, 'Jay Huff','C',27, 57,62,64,75, 52,52,38,37,33,15, 40,66,56,47,66,53, 55,77,40, 4,'PF','USA',216,108,0,0); //Memphis
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl243 = new Player(243,'Jimmy Butler','PF',36, 76,71,65,85, 72,66,74,82,76,53, 38,38,82,76,20,70, 83,81,0, 14,'SF','USA',201,104,2011,30); // Miami Heat
let pl244 = new Player(244,'Bam Adebayo','C',28, 76,60,35,75, 76,75,64,74,59,41, 48,86,78,83,53,55, 80,90,30,  8,'PF','USA',206,115,2017,14); // Miami Heat
let pl245 = new Player(245,'Tyler Herro','SG',25, 58,70,73,87, 62,49,69,68,73,48, 10,52,82,46,5,40, 81,80,60,  6,'PG','USA',196,88,2019,13); // Miami Heat
let pl246 = new Player(246,'Terry Rozier', "PG",31, 61,80,65,86, 74,52,72,72,78,60, 16,37,79,52,20,53, 83,82,0, 10,'SG','USA',185,86,2015,16); // Miami Heat
let pl247 = new Player(247,'Jaime Jaquez Jr.','SF',24, 61,74,52,81, 72,58,57,65,63,33, 28,35,65,61,15,59, 78,80,70, 2,'SG','USA',198,102,2023,18); // Miami Heat
let pl248 = new Player(248,'Duncan Robinson','SF',31, 51,75,76,88, 62,25,49,55,62,36, 6,30,70,40,15,45, 76,83,0, 7,'SG','USA',201,97,0,0); // Miami Heat
let pl249 = new Player(249,'Kevin Love','PF',37, 68,63,60,82, 60,72,56,44,42,40, 46,90,68,51,20,35, 79,77,0, 17,'C','USA',203,113,2008,5); // Miami Heat
let pl250 = new Player(250,'Nikola Jovic','PF',22, 56,60,66,77, 62,34,58,58,60,36, 22,67,60,49,30,50, 68,80,90, 3,'C','Serbia',208,94,2022,27); // Miami Heat
let pl251 = new Player(251,'Alec Burks','SG',34, 60,65,68,86, 59,38,68,68,69,32, 14,40,70,52,15,50, 72,85,0, 14,'SF','USA',198,97,2011,12); // Miami Heat
let pl252 = new Player(252,'Josh Richardson','SG',32, 50,72,58,90, 62,47,70,71,68,34, 18,34,59,63,25,56, 78,83,0, 10,'PG','USA',196,90,2015,40); // Miami Heat
let pl253 = new Player(253,'Haywood Highsmith','SF',29, 51,60,74,63, 69,40,60,71,60,17, 36,41,51,69,55,40, 68,86,20, 5,'PF','USA',201,99,0,0); // Miami Heat
let pl254 = new Player(254,'Pelle Larsson','SG',24, 51,68,71,76, 69,45,77,70,52,33, 16,32,51,48,25,59, 60,80,70, 1,'SF','Sweden',196,97,2024,44); // Miami Heat
let pl255 = new Player(255,'Keshad Johnson','SF',24, 56,60,55,70, 79,55,82,70,55,17, 38,37,55,46,46,50, 60,80,70, 1,'PF','USA',198,102,0,0); // Miami Heat
let pl256 = new Player(256,'Dru Smith','SG',28, 45,64,56,84, 52,33,60,60,66,43, 22,43,51,57,56,86, 61,80,30, 3,'PG','USA',190,92,0,0); // Miami Heat
let pl257 = new Player(257,"Kel'el Ware",'C',21, 65,61,53,63, 80,49,56,58,42,19, 49,65,56,45,68,40, 60,80,100, 1,'PF','USA',213,104,2024,15); // Miami Heat
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl258 = new Player(258,'Giannis Antetokounmpo','PF',31, 83,62,48,67, 75,84,79,76,77,67, 54,90,97,82,55,60, 82,91,0, 12,'SF','Greece',211,109,2013,15); // Milwaukee
let pl259 = new Player(259,'Damian Lillard','PG',35, 58,78,70,92, 79,53,77,77,85,70, 10,40,94,51,15,50, 86,98,0,  13,'SG','USA',188,88,2012,6); // Milwaukee
let pl260 = new Player(260,'Khris Middleton','SF',34, 67,87,69,83, 56,63,61,74,67,71, 20,53,80,65,20,54, 81,90,0,  13,'SG','USA',201,100,2012,39); // Milwaukee
let pl261 = new Player(261,'Brook Lopez','C',37, 70,84,63,81, 50,79,25,50,25,19, 48,50,64,70,88,35, 80,79,0, 17,'PF','USA',216,127,2008,10); // Milwaukee
let pl262 = new Player(262,'Gary Trent Jr.','SG',26, 58,66,72,77, 80,48,75,75,69,21, 10,29,70,47,10,59, 78,82,50, 7,'SF','USA',196,94,2018,37); // Milwaukee
let pl263 = new Player(263,'Anzejs Pasecniks','C',30, 60,57,40,58, 37,58,35,42,22,15, 70,53,59,50,66,36, 65,80,10, 3,'PF','Latvia',216,103,2017,25); // Milwaukee
let pl264 = new Player(264,'Bobby Portis','PF',30, 73,75,68,79, 54,70,55,54,42,20, 60,83,80,55,30,50, 72,84,10, 10,'C','USA',208,113,2015,22); // Milwaukee
let pl265 = new Player(265,'Taurean Prince','SF',31, 58,59,67,81, 74,50,70,68,60,25, 10,36,65,58,30,54, 74,81,0, 9,'PF','USA',198,98,2016,12); // Milwaukee
let pl266 = new Player(266,'Delon Wright','PG',33, 46,58,55,80, 59,48,63,74,76,58, 28,40,51,70,30,91, 70,84,0, 10,'SG','USA',196,83,2015,20); // Milwaukee
let pl267 = new Player(267,'Pat Connaughton','SG',32, 52,59,55,75, 80,35,67,68,68,35, 26,51,53,55,25,45, 69,83,0, 10,'SF','USA',196,94,2015,41); // Milwaukee
let pl268 = new Player(268,'MarJon Beauchamp','SF',25, 50,71,60,70, 72,42,66,66,60,18, 34,46,63,50,20,45, 63,80,60, 3,'SG','USA',198,90,2022,24); // Milwaukee
let pl269 = new Player(269,'Andre Jackson Jr.','SG',24, 51,58,60,72, 74,40,77,77,59,31, 54,44,47,58,20,50, 60,80,70, 2,'SF','USA',198,95,2023,36); // Milwaukee
let pl270 = new Player(270,'A.J. Green','SG',26, 44,70,82,88, 65,32,59,59,60,19, 10,34,69,42,5,35, 61,80,50, 3,'SF','USA',193,90,0,0); // Milwaukee
let pl271 = new Player(271,'Ryan Rollins','PG',23, 53,66,63,79, 70,29,76,76,68,50, 26,37,55,47,41,56, 60,80,80, 3,'SG','USA',193,81,2022,44); // Milwaukee
let pl272 = new Player(272,'Tyler Smith','PF',21, 61,65,56,73, 74,48,62,59,47,12, 37,50,50,43,59,45, 60,80,100, 1,'C','USA',211,101,2024,33); // Milwaukee
let pl273 = new Player(273,'Stanley Umude','SG',26, 46,60,59,91, 60,42,57,58,58,19, 19,55,55,52,40,45, 60,82,50, 3,'SF','USA',198,95,0,0); // Milwaukee
let pl274 = new Player(274,'AJ Johnson','SG',21, 44,64,59,75, 66,29,73,69,76,45, 27,41,55,41,24,46, 60,80,100, 1,'PG','USA',193,72,2024,23); // Milwaukee
let pl275 = new Player(275,'Chris Livingston','SF',22, 51,58,50,72, 73,44,70,70,59,20, 24,51,50,47,35,47, 60,80,90, 2,'PF','USA',198,99,2023,58); // Milwaukee
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl276 = new Player(276,'Anthony Edwards','SG',24, 73,77,65,83, 87,52,81,80,76,53, 16,49,90,67,30,60, 84,83,70, 5,'SF','USA',193,102,2020,1); // Minnesota
let pl277 = new Player(277,'Rudy Gobert','C',33, 66,44,0,63, 47,77,38,55,25,14, 80,97,64,73,84,40, 80,81,0, 12,'PF','USA',216,117,2013,27); // Minnesota
let pl278 = new Player(278,'Julius Randle','PF',31, 77,75,49,74, 59,77,63,66,70,51, 44,83,88,56,20,35, 82,84,0, 11,'C','USA',203,113,2014,7); // Minnesota
let pl279 = new Player(279,'Mike Conley','PG',38, 41,57,80,91, 72,30,73,74,79,74, 12,30,60,60,15,64, 81,82,0, 18,'SG','USA',183,79,2007,4); // Minnesota
let pl280 = new Player(280,'Naz Reid','C',26, 77,66,71,71, 65,77,40,44,48,21, 42,65,75,63,71,54, 69,80,50, 6,'PF','USA',206,119,0,0); // Minnesota
let pl281 = new Player(281,'Donte DiVincenzo','SG',28, 48,71,75,77, 75,50,77,77,69,39, 28,48,73,69,20,73, 75,81,30, 7,'SF','USA',193,92,2018,17); // Minnesota
let pl282 = new Player(282,'Jaden McDaniels','SF',25, 57,62,61,72, 70,50,69,83,68,18, 26,36,55,78,53,51, 77,90,60, 5,'PF','USA',206,83,2020,28); // Minnesota
let pl283 = new Player(283,'Nickeil Alexander-Walker','SG',27, 60,64,69,73, 60,50,62,74,71,40, 14,35,60,68,40,59, 69,80,40, 6,'SF','Canada',196,92,2019,17); // Atlanta
let pl284 = new Player(284,'Luka Garza','C',27, 61,60,52,72, 38,59,30,30,25,20, 93,40,70,37,54,54, 58,80,40, 4,'PF','USA',208,106,2021,52); // Minnesota
let pl285 = new Player(285,'Joe Ingles','SF',38, 49,65,81,77, 50,54,56,70,60,53, 12,41,51,60,10,59, 74,80,0, 11,'PF','Australia',206,99,0,0); // Minnesota
let pl286 = new Player(286,'Rob Dillingham','PG',20, 49,71,60,80, 75,29,81,76,80,41, 17,32,60,44,22,48, 60,80,100, 1,'SG','USA',185,79,2024,8); // Minnesota
let pl287 = new Player(287,'Terrence Shannon Jr.','SG',25, 57,66,55,80, 73,48,79,77,69,19, 17,47,50,50,22,54, 60,80,60, 1,'SF','USA',198,97,2024,27); // Minnesota
let pl288 = new Player(288,'PJ Dozier','SF',29, 51,60,50,67, 75,30,73,66,66,36, 24,49,56,54,30,56, 65,81,20, 7,'SG','USA',198,92,0,0); // Minnesota
let pl289 = new Player(289,'Leonard Miller','SF',22, 59,60,62,79, 72,45,63,63,60,55, 52,71,55,50,35,52, 60,80,91, 2,'PF','Canada',208,95,2023,33); // Minnesota
let pl290 = new Player(290,'Josh Minott','SF',23, 57,55,54,75, 70,52,62,62,53,22, 24,58,55,57,70,60, 60,80,80, 3,'PF','Jamaica',203,92,2022,45); // Minnesota
let pl291 = new Player(291,'Daishen Nix','PG',23, 50,50,45,67, 65,53,80,76,65,52, 16,32,51,43,10,63, 62,80,80, 4,'SG','USA',196,101,0,0); // Minnesota
let pl292 = new Player(292,'Jesse Edwards','C',25, 54,30,0,61, 47,55,45,42,34,26, 68,67,50,47,68,49, 60,80,60, 1,'PF','Netherlands',211,104,0,0); // Minnesota
let pl293 = new Player(293,'Jaylen Clark','SG',24, 48,50,50,69, 67,45,69,76,56,29, 31,50,50,63,40,78, 60,79,70, 1,'SF','USA',196,92,2023,53); // Minnesota
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl294 = new Player(294,'Zion Williamson','PF',25, 85,69,34,70, 89,82,75,75,68,57, 50,48,90,52,40,63, 81,60,60, 5,'C','USA',198,128,2019,1); // New Orleans
let pl295 = new Player(295,'Dejounte Murray','PG',29, 60,86,60,79, 50,30,73,75,78,65, 22,60,82,68,15,70, 79,80,20, 8,'SG','USA',196,81,2016,29); // New Orleans
let pl296 = new Player(296,'Brandon Ingram','SF',28, 74,83,58,80, 67,32,64,64,75,62, 16,49,82,54,35,45, 83,85,30, 9,'PF','USA',203,85,2016,2); // New Orleans
let pl297 = new Player(297,'CJ McCollum','SG',34, 51,75,81,80, 70,50,72,74,76,51, 14,41,81,51,35,50, 82,80,0, 12,'PG','USA',190,86,2013,10); // New Orleans
let pl298 = new Player(298,'Herbert Jones','SF',27, 62,68,73,82, 62,49,64,83,65,31, 30,31,59,76,50,74, 80,80,40, 4,'SG','USA',203,95,2021,35); // New Orleans
let pl299 = new Player(299,'Daniel Theis','C',33, 64,66,46,71, 65,72,47,57,39,23, 56,61,59,62,74,45, 69,65,0, 8,'PF','Germany',203,111,0,0); // New Orleans
let pl300 = new Player(300,'Trey Murphy III','SF',25, 57,53,75,86, 72,50,74,74,40,26, 22,51,70,56,30,58, 75,80,60, 4,'PF','USA',203,93,2021,17); // New Orleans
let pl301 = new Player(301,'Jose Alvarado','PG',27, 40,63,58,73, 68,32,66,76,63,52, 18,36,59,68,25,84, 68,80,40, 4,'SG','Puerto Rico',183,81,0,0); // New Orleans
let pl302 = new Player(302,'Jordan Hawkins','SG',23, 48,63,66,84, 57,38,60,62,65,22, 18,38,69,47,10,30, 67,80,80, 2,'PG','USA',196,88,2023,14); // New Orleans
let pl303 = new Player(303,'Javonte Green','SF',32, 58,60,54,75, 75,36,62,64,62,15, 42,46,54,69,40,70, 66,82,0, 6,'PF','USA',193,92,0,0); // New Orleans
let pl304 = new Player(304,'Jeremiah Robinson-Earl','PF',25, 63,56,58,77, 59,50,52,52,59,18, 54,58,55,46,25,50, 67,80,60, 4,'C','USA',206,104,2021,32); // New Orleans
let pl305 = new Player(305,'Brandon Boston Jr.','SF',24, 45,64,51,77, 70,40,69,73,66,22, 22,40,65,45,30,54, 62,83,70, 4,'SG','USA',201,83,2021,51); // New Orleans
let pl306 = new Player(306,'Trey Jemison','C',26, 60,40,1,68, 62,66,45,42,30,17, 80,44,51,54,74,40, 72,82,50, 2,'PF','USA',211,117,0,0); // New Orleans
let pl307 = new Player(307,'Karlo Matkovic','PF',24, 61,59,48,68, 57,52,46,41,45,20, 45,59,50,53,64,46, 60,80,70, 1,'C','Bosnia and Herzegovina',211,104,2022,52); // New Orleans
let pl308 = new Player(308,'Yves Missi','C',21, 62,32,1,59, 75,57,68,57,25,17, 45,55,50,54,59,40, 60,80,100, 1,'PF','Cameroon',211,106,2024,21); // New Orleans
let pl309 = new Player(309,'Jamal Cain','PF',26, 58,49,60,77, 65,50,56,58,43,16, 44,43,58,54,20,65, 61,83,50, 3,'SF','USA',201,86,0,0); // New Orleans
let pl310 = new Player(310,'Antonio Reeves','SG',25, 46,69,68,84, 65,29,73,68,60,20, 20,37,60,42,10,35, 60,80,60, 1,'SF','USA',196,92,2024,47); // New Orleans
let pl311 = new Player(311,'Matt Ryan','SF',28, 48,55,81,88, 59,44,45,54,57,17, 10,29,58,40,5,30, 61,79,30, 4,'SG','USA',198,97,0,0); // New Orleans
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl312 = new Player(312,'Jalen Brunson','PG',29, 61,83,81,82, 65,50,74,74,85,60, 12,35,95,55,5,45, 78,81,20, 7,'SG','USA',188,86,2018,33); //New York
let pl313 = new Player(313,'Karl-Anthony Towns','PF',30, 78,75,81,87, 60,77,66,66,55,34, 58,86,90,52,56,40, 83,82,10, 10,'C','Dominican',213,112,2015,1); //New York
let pl314 = new Player(314,'Mikal Bridges','SG',29, 60,66,74,84, 75,58,70,79,72,28, 20,35,80,66,30,59, 82,90,20, 7,'SF','USA',198,94,2018,10); //New York
let pl315 = new Player(315,'OG Anunoby','SF',28, 55,81,74,74, 75,58,71,81,62,20, 26,39,64,79,35,68, 79,81,30, 8,'PF','United Kingdom',201,105,2017,23); //New York
let pl316 = new Player(316,'Josh Hart','SG',30, 57,62,54,75, 59,54,71,76,69,34, 34,73,56,66,20,55, 79,82,10, 8,'SF','USA',193,97,217,30); //New York
let pl317 = new Player(317,'Mitchell Robinson','C',27, 65,58,0,51, 73,74,38,55,30,9, 97,62,51,69,84,60, 74,80,40, 7,'PF','USA',213,108,2018,36); //New York
let pl318 = new Player(318,'Precious Achiuwa','PF',26, 61,50,37,60, 69,68,65,64,39,18, 70,68,60,63,56,45, 69,76,50, 5,'C','Nigeria',203,102,2020,20); //New York
let pl319 = new Player(319,'Miles McBride','PG',25, 49,79,70,75, 70,34,76,76,78,33, 14,21,60,58,10,65, 64,80,60, 4,'SG','USA',188,90,2021,36); //New York
let pl320 = new Player(320,'Cameron Payne','PG',31, 42,80,68,83, 62,29,65,65,76,66, 12,36,65,41,20,60, 67,84,0, 10,'SG','USA',190,83,2015,14); //New York
let pl321 = new Player(321,'Jericho Sims','C',27, 62,59,0,58, 73,55,70,70,25,13, 80,63,45,48,60,30, 64,80,40, 4,'PF','USA',208,111,2021,58); //New York
let pl322 = new Player(322,'Tyler Kolek','PG',24, 47,69,59,83, 64,44,64,74,76,56, 25,35,50,48,15,56, 60,80,70, 1,'SG','USA',185,88,2024,34); //New York
let pl323 = new Player(323,'Pacome Dadiet','SG',20, 51,66,60,75, 55,40,68,66,65,24, 22,39,50,50,30,40, 60,80,100, 1,'SF','France',201,95,2024,25); //New York
let pl324 = new Player(324,'Kevin McCullar','SF',24, 58,65,59,79, 65,45,65,72,56,23, 24,45,50,57,43,46, 60,80,70, 1,'SG','USA',196,95,2024,56); //New York
let pl325 = new Player(325,'Ariel Hukporti','C',23, 56,47,32,61, 58,58,37,37,35,15, 62,68,50,46,80,28, 60,82,80, 1,'PF','Germany',213,111,2024,58); //New York
let pl326 = new Player(326,'Jacob Toppin','SF',25, 55,59,49,67, 72,52,58,58,58,24, 37,52,50,53,41,38, 54,80,60, 2,'PF','USA',206,92,0,0); //New York
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl327 = new Player(327,'Shai Gilgeous-Alexander','PG',27, 72,85,72,87, 75,50,76,76,84,66, 18,49,98,79,45,85, 82,80,40, 7,'SG','Canada',198,81,2018,11);// Oklahoma
let pl328 = new Player(328,'Chet Holmgren','C',23, 73,76,71,78, 65,35,65,65,55,30, 40,79,82,73,89,40, 79,80,80, 2,'PF','USA',216,94,2022,2);// Oklahoma
let pl329 = new Player(329,'Jalen Williams','SG',24, 61,86,78,80, 76,40,77,77,76,52, 20,41,82,62,35,65, 80,80,70, 3,'SF','USA',196,88,2022,12);// Oklahoma
let pl330 = new Player(330,'Alex Caruso','SG',31, 47,75,70,76, 62,31,72,84,68,45, 22,37,51,80,56,82, 72,81,0, 8,'PG','USA',196,84,0,0);// Oklahoma
let pl331 = new Player(331,'Isaiah Hartenstein','C',27, 62,60,31,68, 60,74,52,52,46,33, 90,72,55,55,74,62, 68,77,40, 7,'PF','USA',213,113,2017,43);// Oklahoma
let pl332 = new Player(332,'Luguentz Dort','SG',26, 56,61,69,82, 77,60,69,82,62,20, 26,34,65,77,40,56, 79,80,50, 6,'SF','Canada',190,97,0,0);// Oklahoma
let pl333 = new Player(333,'Aaron Wiggins','SF',26, 58,58,75,78, 62,35,74,74,60,25, 36,37,67,51,30,66, 68,80,50, 4,'SG','USA',198,90,2021,55);// Oklahoma
let pl334 = new Player(334,'Isaiah Joe','SG',26, 52,84,79,83, 69,37,62,67,64,25, 16,37,67,49,15,53, 65,87,50, 5,'PG','USA',193,74,2020,49);// Oklahoma
let pl335 = new Player(335,'Cason Wallace','SG',22, 49,71,75,78, 62,45,65,77,68,25, 22,30,55,64,40,71, 71,80,90, 2,'PG','USA',193,87,2023,10);// Oklahoma
let pl336 = new Player(336,'Jaylin Williams','C',23, 63,66,70,74, 52,50,40,47,49,44, 32,79,54,57,53,53, 65,80,80, 3,'PF','USA',206,108,2022,34);// Oklahoma
let pl337 = new Player(337,'Ousmane Dieng','PF',22, 53,63,50,73, 69,39,68,68,60,31, 22,52,56,40,25,50, 63,80,90, 3,'SF','France',208,97,2022,11);// Oklahoma
let pl338 = new Player(338,'Kenrich Williams','PF',31, 54,55,66,51, 62,53,56,65,59,32, 46,51,53,61,25,60, 70,80,0, 7,'SF','USA',198,95,0,0);// Oklahoma
let pl339 = new Player(339,'Nikola Topic','PG',20, 53,59,57,87, 59,49,69,66,76,56, 22,37,55,46,27,44, 60,80,100, 1,'SG','Serbia',198,90,2024,12);// Oklahoma
let pl340 = new Player(340,'Ajay Mitchell','SG',23, 47,63,63,85, 77,55,73,70,69,42, 18,34,50,47,25,52, 60,80,80, 1,'PG','Belgium',190,86,2024,38);// Oklahoma
let pl341 = new Player(341,'Dillon Jones','SF',24, 53,60,57,80, 61,60,65,72,60,38, 42,54,50,54,27,60, 60,80,70, 1,'PF','USA',196,106,2024,26);// Oklahoma
let pl342 = new Player(342,'Malevy Leons','SF',26, 56,58,59,79, 50,45,42,65,37,22, 48,60,50,63,63,67, 60,80,50, 1,'PF','Netherlands',206,95,0,0);// Oklahoma
let pl343 = new Player(343,'Alex Ducas','SG',25, 46,62,63,77, 60,55,47,57,59,21, 22,44,50,44,20,44, 60,80,60, 1,'SF','Australia',201,99,0,0);// Oklahoma
let pl344 = new Player(344,'Adam Flagler','SG',26, 45,67,64,81, 60,37,62,60,59,30, 17,37,50,40,20,45, 60,80,50, 2,'PG','USA',190,83,0,0);// Oklahoma
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl345 = new Player(345,'Paolo Banchero','PF',23, 81,87,59,72, 73,67,70,70,66,55, 24,61,86,53,30,45, 84,80,80, 3,'SF','USA',208,113,2022,1);// Orlando
let pl346 = new Player(346,'Franz Wagner','SF',24, 69,68,63,85, 65,55,60,63,75,41, 22,48,80,62,20,55, 81,80,70, 4,'SG','Germany',208,102,2021,8);// Orlando
let pl347 = new Player(347,'Jalen Suggs','PG',24, 59,69,65,77, 80,49,78,83,76,45, 20,35,69,74,40,75, 76,80,70, 4,'SG','USA',196,92,2021,5);// Orlando
let pl348 = new Player(348,'Wendell Carter Jr.','C',26, 75,68,56,72, 58,72,58,45,40,26, 60,81,68,62,50,40, 77,81,50, 7,'PF','USA',208,122,2018,7);// Orlando
let pl349 = new Player(349,'Goga Bitadze','C',26, 62,52,38,67, 53,74,43,44,50,30, 78,67,60,51,89,50, 63,80,50,  6,'PF','Georgia',211,113,2019,18);// Orlando
let pl350 = new Player(350,'Kentavious Caldwell-Pope','SG',32, 50,75,70,82, 59,50,75,74,65,27, 14,30,60,67,15,63, 79,84,0, 12,'SF','USA',196,92,2013,8);// Orlando
let pl351 = new Player(351,'Moritz Wagner','C',28, 65,68,56,81, 65,58,63,57,42,26, 44,63,70,45,30,55, 66,81,30, 7,'PF','Germany',211,111,2018,25);// Orlando
let pl352 = new Player(352,'Anthony Black','PG',21, 55,60,63,66, 65,48,65,68,76,38, 20,32,56,59,40,56, 68,80,100, 2,'SG','USA',201,89,2023,6);// Orlando
let pl353 = new Player(353,'Jonathan Isaac','PF',28, 60,63,63,76, 70,60,63,70,66,14, 60,74,60,77,84,60, 71,67,30, 6,'C','USA',208,104,2017,6);// Orlando
let pl354 = new Player(354,'Cole Anthony','PG',25, 60,64,60,84, 67,49,74,74,74,56, 26,53,68,49,35,59, 75,98,60, 5,'SG','USA',188,83,2020,15);// Orlando
let pl355 = new Player(355,'Jett Howard','SF',22, 53,68,64,80, 62,48,59,59,63,19, 22,33,60,51,59,30, 60,80,90, 2,'SG','USA',203,97,2023,11);// Orlando
let pl356 = new Player(356,'Tristan Da Silva','SF',24, 59,69,62,84, 57,52,75,57,59,27, 26,44,53,49,15,20, 75,80,70, 1,'PF','Germany',203,98,2024,18);// Orlando
let pl357 = new Player(357,'Gary Harris','SG',31, 51,69,69,81, 68,43,65,70,66,25, 14,23,54,61,15,60, 77,83,0, 11,'SF','USA',193,95,2014,19);// Orlando
let pl358 = new Player(358,'Caleb Houstan','SG',22, 38,66,65,81, 62,30,68,72,60,13, 28,27,50,56,15,30, 63,80,90, 3,'SF','Canada',203,92,2022,32);// Orlando
let pl359 = new Player(359,'Cory Joseph','PG',34, 40,65,72,78, 55,30,62,70,74,50, 16,33,55,53,20,54, 71,84,0, 14,'SG','Canada',188,90,2011,29);// Orlando
let pl360 = new Player(360,'Mac McClung','SG',26, 51,54,60,64,72,38,69,60,59,61, 30,56,55,45,32,52, 60,82,50, 3,'PG','USA',188,83,0,0);// Orlando
let pl361 = new Player(361,'Trevelin Queen','SG',28, 51,58,50,73, 65,39,60,60,60,32, 42,40,56,50,60,66, 60,83,30, 4,'SF','USA',198,86,0,0);// Orlando
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl362 = new Player(362,'Joel Embiid','C',31, 88,80,62,82, 59,86,59,59,47,45, 50,95,98,72,75,50, 81,76,0, 9,'PF','USA',213,127,2014,3); //Philadelphia
let pl363 = new Player(363,'Tyrese Maxey','PG',25, 62,69,71,86, 70,34,80,80,79,59, 10,30,90,58,25,45, 81,77,60, 5,'SG','USA',188,90,2020,21); //Philadelphia
let pl364 = new Player(364,'Paul George','PF',35, 66,82,72,85, 78,60,69,77,77,40, 18,58,88,75,25,76, 83,93,0, 15,'SF','USA',203,99,2010,10); //Philadelphia
let pl365 = new Player(365,'Jared McCain','SG',21, 51,81,72,93, 58,42,66,66,76,42, 16,24,75,45,5,40, 73,80,100, 1,'PG','USA',188,88,2024,16); //Philadelphia
let pl366 = new Player(366,'Kelly Oubre Jr.','SF',30, 61,55,55,75, 85,48,62,72,64,18, 32,47,70,54,40,60, 76,84,10, 10,'SG','USA',203,92,2015,15); //Philadelphia
let pl367 = new Player(367,'Guerschon Yabusele','PF',30, 60,69,66,66, 60,64,52,50,56,25, 68,52,63,49,45,50, 72,84,10, 3,'C','France',203,117,2016,16); //Philadelphia
let pl368 = new Player(368,'Kyle Lowry','PG',39, 43,75,66,81, 62,57,74,74,69,60, 18,40,55,68,20,60, 81,79,0, 19,'SG','USA',183,88,2006,24); //Philadelphia
let pl369 = new Player(369,'Caleb Martin','SF',30, 57,57,58,75, 64,48,58,64,59,29, 32,43,58,59,30,60, 74,80,10, 6,'PF','USA',196,92,0,0); //Philadelphia
let pl370 = new Player(370,'Andre Drummond','C',32, 63,37,12,59, 69,85,50,48,35,16, 91,97,60,64,60,77, 77,81,0, 13,'PF','USA',211,126,2012,9); //Philadelphia
let pl371 = new Player(371,'KJ Martin','PF',24, 61,58,53,66, 80,52,73,73,66,20, 40,50,60,52,40,40, 71,81,70, 5,'SF','USA',198,97,2020,52); //Philadelphia
let pl372 = new Player(372,'Eric Gordon','SG',37, 55,70,70,81, 72,50,69,69,69,31, 8,22,65,52,20,50, 81,78,0, 17,'SF','USA',190,97,2008,7); //Philadelphia
let pl373 = new Player(373,'Reggie Jackson','PG',35, 45,67,65,85, 75,38,74,74,76,60, 14,33,66,55,10,50, 75,84,0, 14,'SG','USA',188,94,2011,24); //Philadelphia
let pl374 = new Player(374,'Ricky Council IV','SG',24, 52,65,50,77, 70,50,64,60,58,22, 30,34,64,44,5,40, 59,80,70, 2,'SF','USA',198,92,0,0); //Philadelphia
let pl375 = new Player(375,'Lester QuiNones','C',25, 47,61,69,69, 64,34,60,60,60,33, 42,46,60,41,10,30, 60,80,60, 3,'PF','Dominican',196,94,0,0); //Philadelphia
let pl376 = new Player(376,'VJ Edgecombe','SG',20, 55,64,67,78, 78,47,79,81,76,46, 28,42,76,72,15,64, 79,80,90, 0,'SF','Bahamas',196,86,2025,3); // UPDATED Philadelphia
let pl377 = new Player(377,'Adem Bona','PF',22, 55,37,0,66,79,63,72,58,42,17, 50,60,50,56,57,60, 60,80,90, 1,'C','Nigeria',208,106,2024,41); //Philadelphia
let pl378 = new Player(378,'Justin Edwards','SG',22, 49,62,56,77, 71,49,72,72,60,20, 32,46,50,48,31,52, 60,80,90, 1,'SF','USA',198,92,0,0); //Philadelphia
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl379 = new Player(379,'Jusuf Nurkic','C',31, 69,78,38,66, 40,80,41,49,30,40, 74,94,67,59,66,60, 74,72,0, 11,'PF','Bosnia and Herzegovina',213,131,2014,16); // Phoenix
let pl380 = new Player(380,'Kevin Durant','PF',37, 80,87,80,84, 67,53,70,74,82,49, 14,62,95,68,53,50, 86,88,0, 17,'SF','USA',211,108,2007,2); // Phoenix
let pl381 = new Player(381,'Josh Okogie','SG',27, 49,68,50,74, 82,40,79,79,66,22, 56,35,60,68,45,76, 69,82,40, 7,'SF','USA',193,96,2018,20); // Phoenix
let pl382 = new Player(382,'Devin Booker','SG',29, 74,87,64,88, 69,49,73,70,83,69, 16,37,93,59,20,45, 84,81,20, 10,'PG','USA',198,93,2015,13); // Phoenix
let pl383 = new Player(383,'Bradley Beal','SG',32, 64,76,73,82, 77,52,66,73,78,54, 22,36,84,54,30,55, 84,82,0, 13,'PG','USA',193,93,2012,3); // Phoenix
let pl384 = new Player(384,'Tyus Jones','PG',29, 45,83,71,81, 47,34,61,61,76,76, 10,30,64,49,10,60, 70,84,20, 10,'SG','USA',185,88,2015,24); // Phoenix
let pl385 = new Player(385,'Mason Plumlee','C',35, 70,50,14,57, 65,70,47,48,27,39, 68,86,60,58,50,40, 72,83,0, 12,'PF','USA',208,115,2013,22); // Phoenix
let pl386 = new Player(386,"Royce O'Neale",'SF',32, 58,60,68,77, 55,57,52,73,58,40, 22,58,55,63,40,53, 76,82,0, 8,'PF','USA',193,102,0,0); // Phoenix
let pl387 = new Player(387,'Grayson Allen','SG',30, 50,60,80,86, 71,44,74,68,68,33, 14,35,64,52,30,50, 75,82,10, 7,'SF','USA',193,89,2018,21); // Phoenix
let pl388 = new Player(388,'Monte Morris','PG',30, 46,80,79,82, 62,41,73,73,76,56, 10,38,56,49,20,56, 74,81,10, 8,'SG','USA',188,83,2017,51); // Phoenix
let pl389 = new Player(389,'Ryan Dunn','SF',22, 49,55,56,53, 69,55,73,80,59,27, 26,39,56,68,55,50, 68,80,90, 1,'PF','USA',198,97,2024,28); // Phoenix
let pl390 = new Player(390,'Bol Bol','PF',26, 66,72,54,74, 59,55,58,58,60,16, 50,77,65,52,80,37, 63,77,50, 6,'C','Sudan',221,99,2019,44); // Phoenix
let pl391 = new Player(391,'Damion Lee','SG',33, 54,66,57,87, 65,45,58,64,60,25, 16,50,60,45,10,53, 70,79,0, 7,'SF','USA',196,95,0,0); // Phoenix
let pl392 = new Player(392,'Oso Ighodaro','PF',23, 62,42,0,62, 80,54,76,64,50,17, 50,66,50,49,55,40, 66,80,80, 1,'C','USA',208,106,2024,40); // Phoenix
let pl393 = new Player(393,'TyTy Washington','PG',24, 44,67,45,75, 69,44,70,70,76,43, 12,33,55,49,5,56, 61,80,70, 3,'SG','USA',190,89,2022,29); // Phoenix
let pl394 = new Player(394,'Collin Gillespie','PG',26, 47,65,75,77, 62,33,72,72,67,43, 10,32,59,47,10,70, 60,80,50, 2,'SG','USA',185,88,0,0); // Phoenix
let pl395 = new Player(395,'Jalen Bridges','SF',24, 53,60,66,79, 52,47,71,67,50,25, 21,41,50,46,25,45, 60,80,70,  1,'PF','USA',203,102,0,0); // Phoenix
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl396 = new Player(396,'Robert Williams','C',28, 64,59,25,67, 65,73,61,54,38,25, 90,76,60,74,85,60, 70,81,30, 7,'PF','USA',206,107,2018,27); // Portland
let pl397 = new Player(397,'Deandre Ayton','C',27, 76,72,35,76, 72,75,65,55,51,19, 72,87,78,58,53,50, 80,81,40, 7,'PF','USA',213,113,2018,1); // Portland
let pl398 = new Player(398,'Shaedon Sharpe','SF',22, 57,81,58,77, 86,40,79,79,73,32, 28,40,77,52,20,50, 75,80,90, 3,'SG','Canada',198,90,2022,7); // Portland
let pl399 = new Player(399,'Anfernee Simons','SG',26, 63,82,68,87, 80,31,76,79,76,58, 10,33,83,41,10,30, 75,80,50, 7,'PG','USA',190,82,2018,24); // Portland
let pl400 = new Player(400,'Jerami Grant','PF',31, 72,71,69,81, 68,59,67,67,66,30, 22,40,80,64,40,45, 77,82,0, 11,'SF','USA',201,95,2014,39); // Portland
let pl401 = new Player(401,'Scoot Henderson','PG',21, 56,77,57,80, 85,53,85,79,76,70, 22,29,70,49,10,50, 78,80,100, 2,'SG','USA',190,91,2023,3); // Portland
let pl402 = new Player(402,'Deni Avdija','SF',24, 59,56,60,74, 69,55,63,69,68,46, 26,73,67,68,30,55, 76,84,70, 5,'PF','Israel',206,95,2020,9); // Portland
let pl403 = new Player(403,'Donovan Clingan','C',21, 64,49,59,72, 50,68,44,45,36,10, 90,75,58,63,90,53, 67,80,100, 1,'PF','USA',218,127,2024,7); // Portland
let pl404 = new Player(404,'Toumani Camara','PF',25, 63,57,60,74, 63,55,53,51,55,20, 56,40,53,59,35,63, 76,80,60, 2,'SF','Belgium',203,99,2023,52); // Portland
let pl405 = new Player(405,'Dalano Banton','PG',26, 52,62,58,71, 65,56,66,66,66,50, 30,46,66,58,40,59, 63,80,50, 4,'SG','USA',206,92,2024,46); // Portland
let pl406 = new Player(406,'Matisse Thybulle','SF',28, 41,40,59,67, 60,49,66,79,55,19, 20,26,48,78,60,93, 71,80,30, 6,'SG','Australia',196,91,2019,20); // Portland
let pl407 = new Player(407,'Jabari Walker','PF',23, 63,60,48,76, 69,46,65,65,50,17, 64,76,59,55,25,45, 67,80,80, 3,'C','USA',206,97,2022,57); // Portland
let pl408 = new Player(408,'Duop Reath','C',29, 55,58,65,74, 65,63,49,52,42,20, 56,47,68,48,55,50, 66,80,20, 2,'PF','South Sudan',211,111,0,0); // Portland
let pl409 = new Player(409,'Kris Murray','SF',25, 56,60,57,60, 65,50,58,63,59,21, 48,36,55,53,25,62, 68,80,60, 2,'PF','USA',203,99,2023,23); // Portland
let pl410 = new Player(410,'Rayan Rupert','SG',21, 49,53,59,75, 59,42,57,62,62,35, 34,39,53,54,15,45, 63,80,100, 2,'SF','France',198,92,2023,43); // Portland
let pl411 = new Player(411,'Bryce McGowens','SG',23, 52,69,58,76, 71,38,64,65,64,23, 16,35,56,50,20,45, 65,80,80, 3,'SF','USA',201,81,2022,40); // Portland
let pl412 = new Player(412,'Justin Minaya','SF',26, 47,60,44,60, 65,45,60,61,60,19, 50,29,45,55,55,40, 62,81,50, 3,'SG','USA',196,95,0,0); // Portland
let pl413 = new Player(413,'Taze Moore','SG',27, 54,58,49,64, 80,45,67,66,58,26, 40,46,50,46,14,50, 60,82,40, 2,'SF','USA',196,88,0,0); // Portland
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl414 = new Player(414,'Domantas Sabonis','C',29, 83,81,53,73, 44,72,48,49,50,73, 72,91,80,49,30,45, 80,86,20, 9,'PF','Lithuania',208,108,2016,11); // Sacramento
let pl415 = new Player(415,'Keegan Murray','PF',25, 64,70,68,85, 69,50,66,69,60,16, 44,53,65,61,40,50, 82,80,60, 3,'SF','USA',203,97,2022,4); // Sacramento
let pl416 = new Player(416,'DeMar DeRozan','SF',36, 73,87,59,84, 78,63,72,72,73,51, 14,39,84,57,25,55, 84,91,0, 16,'PF','USA',198,99,2009,9); // Sacramento
let pl417 = new Player(417,'Malik Monk','SG',27, 57,70,65,84, 78,38,70,71,69,70, 12,36,79,51,35,45, 72,80,40, 8,'PG','USA',190,90,2017,11); // Sacramento
let pl418 = new Player(418,"De'Aaron Fox",'PG',28, 53,81,59,74, 74,36,87,83,78,66, 18,37,93,63,20,78, 83,80,30, 8,'SG','USA',190,83,2017,5); // Sacramento
let pl419 = new Player(419,'Keon Ellis','SG',25, 46,64,76,78, 69,38,71,74,64,27, 26,30,55,74,58,80, 66,80,60, 3,'SF','USA',198,79,0,0); // Sacramento
let pl420 = new Player(420,'Kevin Huerter','SG',27, 50,59,67,76, 65,40,74,68,69,38, 18,43,66,55,25,56, 78,83,40, 7,'SF','USA',201,86,2018,19); // Sacramento
let pl421 = new Player(421,'Trey Lyles','PF',30, 67,65,70,74, 55,59,56,49,48,22, 18,68,65,50,35,40, 68,84,10, 10,'C','Canada',206,106,2015,12); // Sacramento
let pl422 = new Player(422,'Alex Len','C',32, 63,51,52,68, 50,65,43,40,22,18, 74,75,55,54,87,45, 67,78,0, 12,'PF','Ukraine',213,113,2013,5); // Sacramento
let pl423 = new Player(423,'Isaac Jones','PF',25, 59,54,25,71, 64,60,60,57,48,18, 42,44,60,50,70,25, 60,80,60, 1,'C','USA',203,111,0,0); // Sacramento
let pl424 = new Player(424,'Jae Crowder','SF',35, 54,73,64,77, 63,72,58,69,65,23, 20,51,55,64,25,56, 74,89,0, 13,'PF','USA',198,106,2012,34); // Sacramento
let pl425 = new Player(425,'Jordan McLaughlin','PG',29, 41,64,74,73, 64,42,63,64,74,72, 20,31,55,51,20,80, 64,83,20, 6,'SG','USA',183,83,0,0); // Sacramento
let pl426 = new Player(426,'Devin Carter','PG',23, 50,57,60,74, 84,50,88,79,69,57, 27,40,55,57,45,55, 64,80,80, 1,'SG','USA',188,88,2024,13); // Sacramento
let pl427 = new Player(427,'Colby Jones','SG',23, 46,58,52,67, 62,40,64,65,58,29, 32,43,55,49,50,64, 60,80,80, 2,'SF','USA',198,92,2023,34); // Sacramento
let pl428 = new Player(428,'Doug McDermott','SF',33, 60,68,81,80, 57,50,49,50,57,18, 14,32,65,43,10,20, 69,83,0, 11,'PF','USA',198,102,2014,11); // Sacramento
let pl429 = new Player(429,'Mason Jones','SG',27, 48,74,64,65, 47,40,54,64,61,49, 16,54,67,46,5,40, 60,80,40, 4,'PG','USA',193,90,0,0); // Sacramento
let pl430 = new Player(430,'Isaiah Crawford','SF',24, 55,64,64,73, 64,49,51,51,47,24, 34,49,50,45,40,60, 60,80,70, 1,'SG','USA',198,99,0,0); // Sacramento
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl431 = new Player(431,'Victor Wembanyama','C',21, 81,61,57,80, 59,47,56,56,60,47, 56,91,90,80,99,63, 80,88,100, 2,'PF','France',221,94,2023,1); // San Antonio
let pl432 = new Player(432,'Harrison Barnes','PF',33, 63,77,70,81, 85,60,67,65,68,20, 24,44,65,53,10,40, 81,82,0, 13,'SF','USA',203,102,2012,7); // San Antonio
let pl433 = new Player(433,'Julian Champagnie','SF',24, 50,64,67,84, 57,37,59,59,58,21, 20,51,64,48,45,55, 71,80,70, 3,'SG','USA',203,99,0,0); // San Antonio
let pl434 = new Player(434,'Devin Vassell','SG',25, 61,81,67,81, 67,59,62,73,72,44, 12,44,81,65,30,60, 76,82,60, 5,'SF','USA',196,90,2020,11); // San Antonio
let pl435 = new Player(435,'Chris Paul','PG',40, 50,74,69,87, 65,52,70,71,77,92, 20,49,59,63,10,70, 78,77,0, 20,'SG','USA',183,79,2005,4); // San Antonio
let pl436 = new Player(436,'Stephon Castle','PG',21, 50,60,56,71, 62,49,72,83,68,52, 18,27,70,62,25,58, 75,80,100, 1,'SG','USA',198,97,2024,4); // San Antonio
let pl437 = new Player(437,'Keldon Johnson','SF',26, 69,73,60,76, 61,60,66,68,69,34, 34,53,79,56,15,45, 79,80,50, 6,'PF','USA',196,99,2019,29); // San Antonio
let pl438 = new Player(438,'Jeremy Sochan','PF',22, 61,57,56,73, 64,50,60,64,69,41, 24,56,70,59,35,53, 78,80,90, 3,'SF','USA',203,104,2022,9); // San Antonio
let pl439 = new Player(439,'Zach Collins','C',28, 65,69,59,75, 69,50,56,55,30,46, 56,63,65,54,59,40, 69,80,30, 7,'PF','USA',211,113,2017,10); // San Antonio
let pl440 = new Player(440,'Charles Bassey','C',25, 55,59,43,63, 72,59,67,67,32,37, 90,88,60,58,88,56, 61,80,60, 4,'PF','Nigeria',208,106,2021,53); // San Antonio
let pl441 = new Player(441,'Sandro Mamukelashvili','PF',26, 60,59,62,72, 59,63,49,49,49,39, 72,81,67,49,50,35, 61,80,50, 4,'C','Georgia',211,108,2021,54); // San Antonio
let pl442 = new Player(442,'Tre Jones','PG',25, 45,60,49,83, 61,50,70,70,74,80, 20,39,63,55,10,60, 71,81,60, 5,'SG','USA',185,83,2020,41); // San Antonio
let pl443 = new Player(443,'Malaki Branham','SG',22, 59,67,65,85, 65,35,72,72,59,35, 12,32,67,44,10,37, 70,80,90, 3,'PG','USA',193,81,2022,20); // San Antonio
let pl444 = new Player(444,'Blake Wesley','SG',22, 58,50,48,65, 74,30,68,68,73,68, 14,32,55,50,20,59, 64,80,90, 3,'PG','USA',196,83,2022,25); // San Antonio
let pl445 = new Player(445,'Sidy Cissoko','SF',21, 53,57,42,65, 70,48,64,65,58,32, 40,40,53,56,30,60, 60,80,100, 2,'PF','France',203,90,2023,44); // San Antonio
let pl446 = new Player(446,'Harrison Ingram','SF',23, 56,63,54,62,72,63,72,65,60,31, 39,50,50,51,29,49, 60,80,80, 1,'PF','USA',196,104,2024,48); // San Antonio
let pl447 = new Player(447,'David Duke Jr.','SG',26, 47,63,49,79, 62,45,73,73,63,39, 50,36,56,41,25,63, 62,83,50, 4,'PG','USA',196,92,0,0); // San Antonio
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl448 = new Player(448,'Jakob Poeltl','C',30, 72,59,33,55, 47,70,41,37,28,35, 88,77,65,63,83,50, 72,80,10, 9,'PF','Austria',213,111,2016,9); // Toronto
let pl449 = new Player(449,'Scottie Barnes','PF',24, 71,78,49,76, 82,64,72,72,69,62, 50,61,80,75,55,56, 85,80,70, 4,'SF','USA',201,102,2021,4); // Toronto
let pl450 = new Player(450,'Gradey Dick','SG',22, 53,80,65,89, 68,44,66,64,69,21, 16,30,75,55,10,50, 73,80,90, 2,'SF','USA',109,92,2023,13); // Toronto
let pl451 = new Player(451,'RJ Barrett','SF',25, 66,60,64,70, 72,66,74,74,73,38, 20,51,82,60,20,35, 83,80,60, 6,'SG','Canada',198,96,2019,3); // Toronto
let pl452 = new Player(452,'Immanuel Quickley','PG',26, 59,61,70,85, 69,44,72,72,76,60, 12,44,80,54,10,50, 75,79,50, 5,'SG','USA',190,86,2020,25); // Toronto
let pl453 = new Player(453,'Kelly Olynyk','C',34, 70,75,70,83, 45,60,31,35,32,50, 44,65,66,54,35,60, 72,82,0, 12,'PF','USA',2013,13,211,108); // Toronto
let pl454 = new Player(454,'Chris Boucher','PF',32, 68,66,56,78, 64,70,47,45,31,10, 70,69,70,55,65,50, 67,77,0, 8,'C','Saint Lucia',206,90,0,0); // Toronto
let pl455 = new Player(455,'Bruce Brown','PG',29, 50,76,56,76, 70,65,68,68,69,37, 30,46,60,58,35,60, 75,84,20, 7,'SG','USA',193,91,2018,42); // Toronto
let pl456 = new Player(456,'Ochai Agbaji','SG',25, 57,70,65,73, 75,54,78,78,65,22, 28,35,56,61,35,50, 72,80,60, 3,'SF','USA',196,97,2022,14); // Toronto
let pl457 = new Player(457,'Davion Mitchell','PG',27, 40,71,59,69, 60,50,72,78,76,52, 12,25,56,64,15,50, 70,80,40, 4,'SG','USA',188,92,2021,9); // Toronto
let pl458 = new Player(458,"Ja Kobe Walter",'SG',21, 52,64,51,66, 66,47,80,72,60,27, 32,30,64,49,25,50, 69,80,100, 1,'SF','USA',196,81,2024,19); // Toronto
let pl459 = new Player(459,'Jonathan Mogbo','PF',24, 56,47,42,72, 65,58,81,69,60,35, 80,53,55,61,50,69, 66,80,70, 1,'C','USA',206,102,2024,31); // Toronto
let pl460 = new Player(460,'Jamal Shead','PG',23, 40,64,63,63, 64,39,87,84,76,79, 10,20,56,51,15,60, 65,80,80, 1,'SG','USA',183,90,2024,45); // Toronto
let pl461 = new Player(461,'A.J. Lawson','SG',25, 53,58,50,54, 70,34,64,64,59,18, 34,44,66,51,10,50, 60,80,60, 3,'SF','Canada',198,81,0,0); // Toronto
let pl462 = new Player(462,'Garrett Temple','SG',39, 44,45,64,74, 59,34,47,66,65,29, 14,33,53,59,30,60, 70,82,0, 15,'SF','USA',196,88,0,0); // Toronto
let pl463 = new Player(463,'Jamison Battle','SF',24, 52,62,80,85, 55,45,54,50,52,26, 32,34,65,45,15,30, 63,80,70, 1,'PF','USA',201,99,0,0); // Toronto
let pl464 = new Player(464,'Ulrich Chomche','PF',20, 53,49,48,50, 72,58,74,64,49,19, 76,48,50,52,64,53, 60,80,100, 1,'C','Cameroon',208,106,2024,57); // Toronto
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl465 = new Player(465,'John Collins','C',28, 75,63,63,79, 75,65,61,55,50,18, 60,79,79,58,55,40, 79,84,30, 8,'PF','USA',206,106,2017,19); // Utah
let pl466 = new Player(466,'Lauri Markkanen','PF',28, 78,70,70,86, 52,51,53,55,55,22, 48,68,85,53,30,45, 81,80,30, 8,'SF','Finland',213,108,2017,7); // Utah
let pl467 = new Player(467,'Walker Kessler','C',24, 69,58,36,54, 50,64,37,42,34,16, 90,80,58,69,93,35, 74,80,70, 3,'PF','USA',213,111,2022,22); // Utah
let pl468 = new Player(468,'Keyonte George','PG',22, 57,69,65,83, 62,45,69,68,77,61, 10,34,77,44,10,35, 78,80,90, 2,'SG','USA',193,83,2023,16); // Utah
let pl469 = new Player(469,'Collin Sexton','SG',27, 51,58,74,85, 74,48,78,78,76,60, 22,23,84,48,10,45, 80,81,40, 7,'PG','USA',190,86,2018,8); // Utah
let pl470 = new Player(470,'Jordan Clarkson','SG',33, 54,67,63,83, 75,44,69,72,78,55, 22,32,82,43,10,55, 77,83,0, 11,'PG','Philippines',190,87,2014,46); // Utah
let pl471 = new Player(471,'Kyle Filipowski','C',22, 62,60,59,57, 56,52,67,47,59,40, 42,72,58,47,20,56, 66,80,90, 1,'PF','USA',211,113,2024,32); // Utah
let pl472 = new Player(472,'Taylor Hendricks','PF',22, 59,65,65,78, 68,52,62,65,59,13, 40,58,56,58,60,60, 71,80,90, 2,'SF','USA',206,95,2023,9); // Utah
let pl473 = new Player(473,'Brice Sensabaugh','SF',22, 55,74,68,90, 60,54,55,57,64,34, 22,53,68,42,15,50, 67,79,90, 2,'SG','USA',198,106,2023,28); // Utah
let pl474 = new Player(474,'Drew Eubanks','C',28, 66,63,39,72, 65,58,51,52,27,22, 66,71,58,49,76,40, 65,83,30, 7,'PF','USA',206,111,0,0); // Utah
let pl475 = new Player(475,'Svi Mykhailiuk','SF',28, 50,70,69,75, 59,44,72,72,54,30, 14,31,66,37,10,56, 65,79,30, 7,'SG','Ukraine',201,92,2018,47); // Utah
let pl476 = new Player(476,'Johnny Juzang','SG',24, 56,75,75,76, 62,45,60,60,62,19, 22,38,60,45,15,30, 66,80,70, 3,'SF','USA',201,97,0,0); // Utah
let pl477 = new Player(477,'Cody Williams','SG',21, 54,56,49,64, 65,41,77,76,72,22, 20,34,45,53,30,35, 69,80,100, 1,'SF','USA',201,86,2024,10); // Utah
let pl478 = new Player(478,'Patty Mills','PG',37, 37,77,59,85, 56,41,73,73,76,35, 10,24,55,48,10,55, 70,82,0, 16,'SG','Australia',188,81,2009,55); // Utah
let pl479 = new Player(479,'Isaiah Collier','PG',21, 49,55,40,45, 65,50,85,78,76,70, 6,42,45,50,15,66, 67,80,100, 1,'SG','USA',190,95,2024,29); // Utah
let pl480 = new Player(480,'Micah Potter','PF',27, 54,60,71,80, 50,60,43,43,32,18, 52,69,53,40,45,30, 62,81,40, 4,'C','USA',208,112,0,0); // Utah
let pl481 = new Player(481,'Oscar Tshiebwe','PF',26, 57,59,27,75, 65,59,65,57,30,12, 80,80,45,50,62,35, 60,80,50, 2,'C','Democratic Republic of the Congo',206,117,0,0); // Utah
let pl482 = new Player(482,'David Jones','SF',24, 49,57,60,78, 68,49,63,66,50,28, 44,49,45,52,25,65, 60,87,70, 1,'SG','Dominican Republic',198,95,0,0); // Utah
// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl483 = new Player(483,'Jonas Valanciunas','C',33, 73,71,34,79, 44,79,52,48,25,32, 78,90,70,54,60,30, 75,81,0, 13,'PF','Lithuania',211,120); // Washington
let pl484 = new Player(484,'Kyle Kuzma','PF',30, 71,59,63,73, 65,64,64,64,67,47, 24,63,79,51,40,30, 81,83,10, 8,'SF','USA',206,100,2017,27); // Washington
let pl485 = new Player(485,'Marvin Bagley III','C',26, 74,64,49,69, 76,70,63,64,52,20, 88,68,70,58,55,35, 73,87,50, 7,'PF','USA',208,106,2018,2); // Washington
let pl486 = new Player(486,'Jordan Poole','SG',26, 55,72,64,87, 63,51,71,71,79,53, 10,30,81,53,20,55, 77,80,50, 6,'SF','USA',193,87,2019,28); // Washington
let pl487 = new Player(487,'Malcolm Brogdon','PG',32, 59,64,76,87, 62,46,67,70,76,60, 20,42,79,58,15,50, 79,84,0, 9,'SG','USA',193,103,2016,36); // Washington
let pl488 = new Player(488,'Alex Sarr','C',20, 65,68,48,66, 67,57,63,62,63,28, 52,55,62,69,85,50, 76,80,100, 1,'PF','France',213,92,2024,2); // Washington
let pl489 = new Player(489,'Corey Kispert','SF',26,47,75,75,80, 59,50,66,66,61,27, 14,34,68,52,15,35, 76,80,50, 4,'SG','USA',201,99,2021,15); // Washington
let pl490 = new Player(490,'Bilal Coulibaly','SF',21, 59,63,56,71, 75,53,72,75,59,25, 26,41,59,64,50,55, 78,80,100, 2,'SG','France',198,88,2023,7); // Washington
let pl491 = new Player(491,'Saddiq Bey','SF',26, 56,61,63,84, 60,59,53,69,66,22, 58,46,70,57,10,50, 80,81,50, 5,'PF','USA',201,97,2020,19); // Washington
let pl492 = new Player(492,'Carlton Carrington','PG',20, 54,78,64,78, 65,44,72,62,72,48, 10,46,55,50,15,45, 80,80,100, 1,'SG','USA',193,86,2024,14); // Washington
let pl493 = new Player(493,'Jared Butler','SG',25, 48,59,56,77, 68,40,70,70,72,74, 14,31,70,42,25,72, 61,80,60, 4,'PG','USA',190,88,2021,40); // Washington
let pl494 = new Player(494,'Justin Champagnie','SF',24, 56,57,70,76, 68,35,63,63,55,20, 70,53,60,52,50,65, 63,80,70, 4,'SG','USA',198,90,0,0); // Washington
let pl495 = new Player(495,'Kyshawn George','SF',22, 52,68,46,72, 62,50,54,59,64,30, 24,44,50,54,50,50, 75,80,90, 1,'SG','Switzerland ',201,90,2024,24); // Washington
let pl496 = new Player(496,'Richaun Holmes','PF',32, 66,60,27,74, 71,72,47,46,48,18, 64,67,56,51,55,35, 69,82,0, 10,'C','USA',208,106,2015,37); // Washington
let pl497 = new Player(497,'Johnny Davis','SG',23, 56,50,48,56, 65,44,68,69,72,20, 20,40,57,61,35,56, 62,80,80, 3,'SF','USA',196,88,2022,10); // Washington
let pl498 = new Player(498,'Patrick Baldwin Jr.','SF',23, 56,62,66,65, 52,59,47,54,48,19, 24,71,65,49,50,55, 60,80,80, 3,'PF','USA',206,99,2022,28); // Washington
let pl499 = new Player(499,'Anthony Gill','PF',33, 60,62,49,75, 69,50,59,57,44,21, 48,44,56,48,35,40, 60,80,0, 5,'C','USA',201,104,0,0); // Washington
let pl500 = new Player(500,'Tristan Vukcevic','C',22, 61,61,52,77, 55,62,47,45,41,29, 32,69,60,47,76,55, 62,80,90, 2,'PF','Italy',208,101,2023,42); // Washington

// ins/2p/3p/ft/ jum/str/spe/qui/dri/pas/ ore/dre/oaw/daw/blk/stl/ end/inj/pot - experience - secondPosition,country,height,weight, draft year,draft pick
let pl501 = new Player(501,'Jeff Green','PF',39, 68,65,63,80, 74,60,53,65,64,19, 26,36,60,54,45,30, 77,82,0, 17,'SF','USA',203,106,2007,5); //Houston
